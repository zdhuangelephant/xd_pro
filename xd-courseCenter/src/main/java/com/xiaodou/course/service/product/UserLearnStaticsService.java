...
public class UserLearnStaticsService {
   ...
   * @return
   */
  public UserLearnStaticsModel findStatics(Integer productId, Integer userId) {
   ...
   * @return
   */
  public Boolean updateLearnStatics(Integer userId, Integer moduleId, ProductItemModel item) {
    ...
    learnStatics.setCurrentItem(item.getId());
