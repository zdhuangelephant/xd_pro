...
import com.xiaodou.queue.factory.MQServerBuilder;
  ...
  protected DefaultMessage createMessage(Object obj) {
    ...
    if (obj instanceof DefaultMessage) {
      ...
      if (obj instanceof String)
        ...
        msg.setMessageBodyJson(FastJsonUtil.toJson(obj));
    ...
    if (null == msg.getSendServerIP()) {
      msg.setSendServerIP(CommUtil.getServerIp());
    }
    if (null == msg.getSendServerName()) {
      msg.setSendServerName(CommUtil.getServerName());
    }
