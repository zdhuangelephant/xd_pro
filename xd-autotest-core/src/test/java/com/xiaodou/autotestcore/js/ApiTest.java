...
/**
 * @name @see com.xiaodou.autotestcore.js.ApiTest.java
...
public class ApiTest {
  ...
  public static Api api_h_1 = new Api();
  ...
  public static void initTestAction() {
    ...
    api_a_1.pushPreSet("srcCourseId", "205767267");
    api_a_1.pushPreSet("courseId", DataSource.Func, "getCourseId(srcCourseId)");
  ...
  public static void initTestOrderApiAction() {
    {
      ...
      api_b_1.pushPreSet("courseId", DataSource.Func, "getCourseId()");
  ...
  public static void initDataSourceApiAction() {
    {
      api_h_1.setUniqueId(UUID.randomUUID().toString());
      api_h_1.setName("api_h_1");
      api_h_1.setUrl("http://119.61.66.57:8020/selftaught/login");
      api_h_1.setTimeOut(5000);
      api_h_1.setResultDataFormat(DataFormat.jSon);
      // 设置参数
      api_h_1.registParam("req", "登录参数");
      api_h_1.registParam("clientIp", ParamType.HeaderParam, "客户端IP");
      api_h_1.registParam("deviceId", ParamType.HeaderParam, "设备ID");
      api_h_1.registParam("clientType", ParamType.HeaderParam, "客户端类型");
      api_h_1.registParam("module", ParamType.HeaderParam, "所属模块");
      api_h_1.registParam("version", ParamType.HeaderParam, "版本号");
      // 设置预设值
      api_h_1
          .pushPreSet(
              "headinfo",
              DataSource.Mysql,
              "2business_temp#ds#select '2' $module$, token $sessionToken$, used_device_id $deviceId$, latest_device_ip $clientIp$, 'ios' $clientType$, '1.3.0' $version$ from xd_user where id = '1';",
      ...
      api_h_1
          .pushPreSet(
              ...
              "{\"platform\":\"local\",\"phoneNum\":\"17700001199\",\"pwd\":\"123456\",\"lat\":\"126.123123\",\"lng\":\"33.8237745\"}");
      // 设置用例
      api_h_1.pushTestCase("tc1", "retcode", "0", DataType.sTring.name());
      // 设置后置变量
      api_h_1.pushAfterSet("token", "sessionToken");
      api_h_1.pushAfterSet("user.id", "uid");
    }
  }
