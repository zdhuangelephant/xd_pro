package com.xiaodou.common.cache.redis.pool;
...
import com.xiaodou.common.cache.pool.JedisMarkPool;
...
public class JedisRandomConnectionPool {
  ...
  /**调度周期*/
  private Long delay = Long.valueOf(JedisProp.getParams("redis.delay"));
