...
<form id="addForm" method="post" class="form-horizontal" role="form" action="/mission/dynamicAdd">

<div class="form-group">
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" style="color:red" for="form-field-1">* 请选择课程</label>
        <div class="col-sm-9">
            <input type="text" id="courseId" list="courseName" name="courseId" value="${courseName}" placeholder="请输入课程名称"   class="form-control"/>
     ...
     <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" style="color:red" for="form-field-2">* 任务名称 </label>
        <div class="col-sm-9">
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" style="color:red" for="form-field-2">* 任务排序</label>
        <div class="col-sm-9">
            <input type="text" datatype="s" sucmsg="haha" name="missionOrder" id="missionOrder" placeholder="" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" style="color:red" for="form-field-1">* 任务类型</label>
        <div class="col-sm-9">
         ...
         <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" style="color:red" for="form-field-1">* 条件类型</label>
        <div class="col-sm-9">
          ...
          <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" style="color:red" for="form-field-1">* 前置条件列表</label>
        <div class="col-sm-9">    
          ...
          <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" style="color:red" for="form-field-1">* 跳转类型</label>
        <div class="col-sm-9">
     ...
     <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" style="color:red" for="form-field-1">* 条件</label>
        <div class="col-sm-9">
   ...
   <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" style="color:red" for="form-field-1">* 取值范围</label>
        <div class="col-sm-9">
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" style="color:red" for="form-field-1">* 取值范围阀值</label>
        <div class="col-sm-9">        
            <input type="text" datatype="s" sucmsg="haha" name="threshold" id="threshold" placeholder="" class="col-xs-10 col-sm-5" />
        </div>
    </div>

      <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" style="color:red" for="form-field-1">* 任务状态</label>
        <div class="col-sm-9">
  ...
  <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" style="color:red" for="form-field-2">* 积分涨幅</label>
        <div class="col-sm-9">
