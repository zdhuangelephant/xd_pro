	...
	<div class="mainBody">
		<div class="right">
			<form name="form1" id="editForm" method="post" class="form-horizontal" role="form"
				action="/tutorMajor/paper/doEdit">
				<input type="hidden" name="type" value="${paper.type}" /> <input
					type="hidden" name="id" value="${paper.id}" />
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right"
						for="form-field-1"> 标题</label>
					<div class="col-sm-9">
						<input type="text" datatype="s" sucmsg="haha"
							value="${paper.author}" id="name" name="title" id="form-field-2"
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right"
						for="form-field-3"> 作者姓名</label>
					<div class="col-sm-9">
						<input type="text" datatype="s" sucmsg="haha"
							value="${paper.title}" id="form-field-3" name="author"
							placeholder="" class="col-xs-10 col-sm-5" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<img class="portrait" src="${paper.contentImage}" alt="正文图片">
						<input type="hidden" datatype="s" sucmsg="haha"
							value="${paper.contentImage}" id="pic" name="contentImage" placeholder=""
		...
		<div id="tempStore" style="display: none;">${paper.content}</div>
	</div>
	<script>
	$(function() {
