	...
	<div class="mainBody">
		<div class="right">
			<form name="form1" id="editForm" method="post" class="form-horizontal" role="form"
				action="/tutorMajor/teacher/doEdit">
				<input type="hidden" name="type" value="${teacher.type}" /> <input
					type="hidden" name="id" value="${teacher.id}" />
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right"
						for="form-field-1"> 导师 </label>
					<div class="col-sm-9">
						<input type="text" datatype="s" sucmsg="haha"
							value="${teacher.author}" id="name" name="author"
							id="form-field-2" placeholder="" class="col-xs-10 col-sm-5" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right"
						for="form-field-3"> 导师头像 </label>
					<div class="col-sm-9">
						<img class="portrait1" src="${teacher.image}" alt="导师头像"> <input
							type="hidden" datatype="s" sucmsg="haha" value="${teacher.image}"
							id="pic1" name="image" placeholder="" class="col-xs-10 col-sm-5" />
						<a onclick="uploadProtrait1()">上传</a>
					</div>
					<br />
					<div class="col-sm-9" style="color: red">*建议上传242*323像素的jpg、png、gif图片</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" datatype="s" sucmsg="haha"
							value="${teacher.title}" id="form-field-3" name="title"
							placeholder="" class="col-xs-10 col-sm-5" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right"
						for="form-field-3"> 副标题(院校)</label>
					<div class="col-sm-9">
						<input type="text" datatype="s" sucmsg="haha"
							value="${teacher.subtitle}" id="form-field-3" name="subtitle"
							placeholder="" class="col-xs-10 col-sm-5" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<img class="portrait2" src="${teacher.contentImage}" alt="正文图片">
						<input type="hidden" datatype="s" sucmsg="haha"
							value="${teacher.contentImage}" id="pic2" name="contentImage"
		...
		<div id="tempStore" style="display: none;">${teacher.content}</div>
	</div>
	<script>
		$(function() {
