...
<link rel="stylesheet" href="/resources/ruide/skins/default/laydate.css">
<link rel="stylesheet" href="/resources/laydate/need/laydate.css">
		...
		<div class="right">
			<form name="form1" id="addForm" method="post" class="form-horizontal" role="form"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="inline layinput">
							<input  name="activityTime" style="width: 285px; height: 34px;"
								class="laydate-icon"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="inline layinput">
							<input name="deadlineTime" style="width: 285px; height: 34px;"
								class="laydate-icon"
								onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" datatype="s" sucmsg="haha" id="name"
							name="activityPlace" id="form-field-2" placeholder=""
							class="col-xs-10 col-sm-5" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<select type="select" id="tutorId" name="tutorId" class="form-control">
							<#list teacherList as teacher>
							<option value="${teacher.id}">${teacher.author}</option> </#list>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<img class="portrait" 
							src="${rc.contextPath}/resources/assets/images/default_portrait.png" alt="正文图片"> 
							<input type="hidden" datatype="s" sucmsg="haha" id="pic" name="contentImage" placeholder=""
							class="col-xs-10 col-sm-5" /> 
