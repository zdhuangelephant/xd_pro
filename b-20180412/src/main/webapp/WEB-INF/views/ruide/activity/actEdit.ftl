...
<body>
	<div class="mainBody">
		<div class="right">
			<form name="form1" id="editForm" method="post" class="form-horizontal" role="form"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" datatype="s" sucmsg="haha"
							value="${activity.title}" id="name" name="title"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" datatype="s" sucmsg="haha"
							value="${activity.subtitle}" id="form-field-3" name="subtitle"
							placeholder="" class="col-xs-10 col-sm-5" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right"
						for="form-field-1"> 活动时间 </label>
					<div class="col-sm-9">
						<div class="inline layinput">
							<input name="activityTime" value="${activity.activityTime}"
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right"
						for="form-field-1"> 截止时间 </label>
					<div class="col-sm-9">
						<div class="inline layinput">
							<input name="deadlineTime" value="${activity.deadlineTime}"
								style="width: 285px; height: 34px;" class="laydate-icon"
								onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
						</div>
					</div>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right"
						for="form-field-1"> 活动地点 </label>
					<div class="col-sm-9">
						<input type="text" datatype="s" sucmsg="haha" id="name"
							name="activityPlace" value="${activity.activityPlace}"
							id="form-field-2" placeholder="" class="col-xs-10 col-sm-5" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right"
						for="form-field-1">相关导师</label>
					<div class="col-sm-9">
						<select id="tutorId" name="tutorId" class="form-control">
							<option value="0">相关导师</option> <#list teacherList as teacher>
							<option value="${teacher.id}"<#if activity.tutorId ==
								teacher.id>selected</#if> >${teacher.author}</option> </#list>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<img class="portrait" src="${activity.contentImage}" alt="正文图片">
						<input type="hidden" datatype="s" sucmsg="haha"
							value="${activity.contentImage}" id="pic" name="contentImage" placeholder=""
		...
		<div id="tempStore" style="display: none;">${activity.content}</div>
	</div>
	<script>
		$(function() {
