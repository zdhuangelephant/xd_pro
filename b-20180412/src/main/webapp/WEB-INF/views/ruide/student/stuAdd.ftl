		...
		<div class="right">
			<form name="form1" id="addForm" method="post" class="form-horizontal" role="form"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<img class="portrait1" src="${rc.contextPath}/resources/assets/images/default_portrait.png" alt="学员头像">
						<input type="hidden" datatype="s" sucmsg="haha" id="pic1"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="inline layinput">
							<input name="publishTime" style="width: 285px; height: 34px;"
								class="laydate-icon"
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" datatype="s" sucmsg="haha" id="name"
							name="thinkDesc" id="form-field-2" placeholder=""
							class="col-xs-10 col-sm-5" />
					</div>
				</div>
