...
<div id="fuelux-wizard" data-target="#step-container">
    <ul class="wizard-steps">
        <li data-target="#step1">
            ...
            <span class="title">选择文档资源</span>
        </li>

        <li data-target="#step2"  class="active">
            <span class="step">2</span>
            <span class="title">编辑文档</span>
        </li>
...
<form id="addForm" method="post" class="form-horizontal" role="form" action="/productItem/doAddDocResource">
    <div class="form-group">
        <input type="hidden" name="productId" value="${productId}">
        <input type="hidden" name="resourceId" value="${doc.id}" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" datatype="s" value="${doc.name}" sucmsg="haha"  name="name" id="form-field-2" placeholder="" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" datatype="s" value="${doc.detail}" sucmsg="haha" id="form-field-3" name="detail" placeholder="" class="col-xs-10 col-sm-5" />
        </div>
    </div>
