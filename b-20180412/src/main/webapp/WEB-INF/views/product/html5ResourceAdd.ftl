...
<div id="fuelux-wizard" data-target="#step-container">
    <ul class="wizard-steps">
        <li data-target="#step1">
            ...
            <span class="title">选择Html5资源</span>
        </li>

        <li data-target="#step2"  class="active">
            <span class="step">2</span>
            <span class="title">编辑html5</span>
        </li>
...
<form id="addForm" method="post" class="form-horizontal" role="form" action="/productItem/doAddHtml5Resource">
    <div class="form-group">
        <input type="hidden" name="productId" value="${productId}">
        <input type="hidden" name="resourceId" value="${html5.id}" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" datatype="s" value="${html5.name}" sucmsg="haha"  name="name" id="form-field-2" placeholder="" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" datatype="s" value="${html5.detail}" sucmsg="haha" id="form-field-3" name="detail" placeholder="" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <label class="radio-inline">
                <input type="radio" name="showStatus" checked="checked"  id="inlineRadio1" value="1"> 是
            </label>
            <label class="radio-inline">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <label class="radio-inline">
                <input type="radio" name="isFree" checked="checked"  id="" value="1"> 是
            </label>
            <label class="radio-inline">
