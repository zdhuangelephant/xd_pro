...
<form id="addForm" method="post" class="form-horizontal" role="form" action="/productItem/doAddVideoResource">
    <div class="form-group">
        <input type="hidden" name="productId" value="${productId}">
        <input type="hidden" name="resourceId" value="${video.id}" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" datatype="s" value="${video.name}" sucmsg="haha"  name="name" id="form-field-2" placeholder="" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" datatype="s" value="${video.detail}" sucmsg="haha" id="form-field-3" name="detail" placeholder="" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <label class="radio-inline">
                <input type="radio" checked="checked"  name="showStatus" id="inlineRadio1" value="1"> 是
            </label>
            <label class="radio-inline">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <label class="radio-inline">
                <input type="radio" checked="checked"  name="isFree" id="" value="1"> 是
            </label>
            <label class="radio-inline">
