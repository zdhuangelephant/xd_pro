...
<form id="editForm" method="post" class="form-horizontal" role="form" action="/productCategory/doEdit">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" datatype="s" sucmsg=" " value="${productCategory.name}" name="name" id="form-field-2" placeholder="" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" datatype="s" sucmsg=" " value="${productCategory.detail}" id="form-field-2" name="detail" placeholder="" class="col-xs-10 col-sm-5" />
        </div>
    </div>
