...
<form id="addForm" method="post" class="form-horizontal" role="form" action="/courseHtml5/doAdd">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-9">
            <input type="text" datatype="s" sucmsg="haha" id="htmlFile" name="fileUrl" placeholder="" class="col-xs-10 col-xs-5" />
            <a onclick="fileUpload('htmlFile','picture',50,'zip,rar')">上传</a>
        </div>
    </div>

    <div class="form-group">
        <label class="col-xs-3 control-label no-padding-right" for="form-field-3"> 访问URL </label>
        <div class="col-xs-9">
