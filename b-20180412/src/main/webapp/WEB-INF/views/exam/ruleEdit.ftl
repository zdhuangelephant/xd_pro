...
<form id="editForm" method="post" class="form-horizontal" role="form" action="/examRule/doEditRule">
...
<!--章节列表-->
    ...
    <tr class="chapterTr chapterTr${chapter.id}" style="display: none;">
        ...
        <#list zhuguan as type>
            <td><input type="text" data-score="${type.score}" class="editorTd chapter${chapter.id} chapterEaseA chapterCognitionⅠ type${type.id}" name="chapter_${chapter.id}_${type.id}_A_Ⅰ" id="${chapter.id}_A_Ⅰ" value="<#assign key='chapter_'+chapter.id+'_'+type.id+'_A_Ⅰ'>${numMap[key]}" /></td>
            <td><input type="text" data-score="${type.score}" class="editorTd chapter${chapter.id} chapterEaseB chapterCognitionⅠ type${type.id}" name="chapter_${chapter.id}_${type.id}_B_Ⅰ" id="${chapter.id}_C_Ⅰ" value="<#assign key='chapter_'+chapter.id+'_'+type.id+'_B_Ⅰ'>${numMap[key]}" /></td>
            <td><input type="text" data-score="${type.score}" class="editorTd chapter${chapter.id} chapterEaseC chapterCognitionⅠ type${type.id}" name="chapter_${chapter.id}_${type.id}_C_Ⅰ" id="${chapter.id}_C_Ⅰ" value="<#assign key='chapter_'+chapter.id+'_'+type.id+'_C_Ⅰ'>${numMap[key]}" /></td>
        </#list>
        ...
        <td rowspan="3" style="text-align: center;vertical-align: middle">
            <p><input type="checkbox" style="" class="importChapter" name="importChapter" <#assign key = "chapter"+chapter.id /> <#if importChaptersMap[key]=="1">checked</#if> data-chapterId="${chapter.id}" value="${chapter.id}" /></p>
        </td>
    </tr>
...
<tr class="success">
    ...
    <td class="tableHeadLeft">Ⅰ</td>
    <#list keguan as type>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumA chaptersumⅠ sumtype${type.id}" name="chaptersum_${product.id}_${type.id}_A_Ⅰ" id="sum_${product.id}_${type.id}_A_Ⅰ" value="<#assign key='chaptersum_'+product.id+'_'+type.id+'_A_Ⅰ'>${numMap[key]}"/></td>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumB chaptersumⅠ sumtype${type.id}" name="chaptersum_${product.id}_${type.id}_B_Ⅰ" id="sum_${product.id}_${type.id}_B_Ⅰ" value="<#assign key='chaptersum_'+product.id+'_'+type.id+'_B_Ⅰ'>${numMap[key]}"/></td>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumC chaptersumⅠ sumtype${type.id}" name="chaptersum_${product.id}_${type.id}_C_Ⅰ" id="sum_${product.id}_${type.id}_C_Ⅰ" value="<#assign key='chaptersum_'+product.id+'_'+type.id+'_C_Ⅰ'>${numMap[key]}"/></td>
    </#list>
    <#list zhuguan as type>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumA chaptersumⅠ sumtype${type.id}" name="chaptersum_${product.id}_${type.id}_A_Ⅰ" id="sum_${product.id}_${type.id}_A_Ⅰ" value="<#assign key='chaptersum_'+product.id+'_'+type.id+'_A_Ⅰ'>${numMap[key]}"/></td>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumB chaptersumⅠ sumtype${type.id}" name="chaptersum_${product.id}_${type.id}_B_Ⅰ" id="sum_${product.id}_${type.id}_B_Ⅰ" value="<#assign key='chaptersum_'+product.id+'_'+type.id+'_B_Ⅰ'>${numMap[key]}"/></td>
...
<tr class="success">
    <td class="tableHeadLeft" >Ⅱ</td>
    <#list keguan as type>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumA chaptersumⅡ sumtype${type.id}" name="chaptersum_${product.id}_${type.id}_A_Ⅱ" id="sum_${product.id}_${type.id}_A_Ⅱ" value="<#assign key='chaptersum_'+product.id+'_'+type.id+'_A_Ⅱ'>${numMap[key]}"/></td>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumB chaptersumⅡ sumtype${type.id}" name="chaptersum_${product.id}_${type.id}_B_Ⅱ" id="sum_${product.id}_${type.id}_B_Ⅱ" value="<#assign key='chaptersum_'+product.id+'_'+type.id+'_B_Ⅱ'>${numMap[key]}"/></td>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumC chaptersumⅡ sumtype${type.id}" name="chaptersum_${product.id}_${type.id}_C_Ⅱ" id="sum_${product.id}_${type.id}_C_Ⅱ" value="<#assign key='chaptersum_'+product.id+'_'+type.id+'_C_Ⅱ'>${numMap[key]}"/></td>
    </#list>
    <#list zhuguan as type>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumA chaptersumⅡ sumtype${type.id}" name="chaptersum_${product.id}_${type.id}_A_Ⅱ" id="sum_${product.id}_${type.id}_A_Ⅱ" value="<#assign key='chaptersum_'+product.id+'_'+type.id+'_A_Ⅱ'>${numMap[key]}"/></td>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumB chaptersumⅡ sumtype${type.id}" name="chaptersum_${product.id}_${type.id}_B_Ⅱ" id="sum_${product.id}_${type.id}_B_Ⅱ" value="<#assign key='chaptersum_'+product.id+'_'+type.id+'_B_Ⅱ'>${numMap[key]}"/></td>
...
<tr class="success">
    <td class="tableHeadLeft">Ⅲ</td>
    <#list keguan as type>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumA chaptersumⅢ sumtype${type.id}" name="chaptersum_${product.id}_${type.id}_A_Ⅲ" id="sum_${product.id}_${type.id}_A_Ⅲ" value="<#assign key='chaptersum_'+product.id+'_'+type.id+'_A_Ⅲ'>${numMap[key]}"/></td>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumB chaptersumⅢ sumtype${type.id}" name="chaptersum_${product.id}_${type.id}_B_Ⅲ" id="sum_${product.id}_${type.id}_B_Ⅲ" value="<#assign key='chaptersum_'+product.id+'_'+type.id+'_B_Ⅲ'>${numMap[key]}"/></td>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumC chaptersumⅢ sumtype${type.id}" name="chaptersum_${product.id}_${type.id}_C_Ⅲ" id="sum_${product.id}_${type.id}_C_Ⅲ" value="<#assign key='chaptersum_'+product.id+'_'+type.id+'_C_Ⅲ'>${numMap[key]}"/></td>
    </#list>
    <#list zhuguan as type>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumA chaptersumⅢ sumtype${type.id}" name="chaptersum_${product.id}_${type.id}_A_Ⅲ" id="sum_${product.id}_${type.id}_A_Ⅲ" value="<#assign key='chaptersum_'+product.id+'_'+type.id+'_A_Ⅲ'>${numMap[key]}"/></td>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumB chaptersumⅢ sumtype${type.id}" name="chaptersum_${product.id}_${type.id}_B_Ⅲ" id="sum_${product.id}_${type.id}_B_Ⅲ" value="<#assign key='chaptersum_'+product.id+'_'+type.id+'_B_Ⅲ'>${numMap[key]}"/></td>
