<div class="modal fade" id="importQuestions" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" id="closeId" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">批量导入试题</h4>
            </div>
...
<div id="download">
	<button onclick="method1('import_questions_table')" type="button" class="btn btn-primary center" style="width:500px;margin-left:50px;">下载模板</button>
	<br/>
	<p class="center">重要说明：先下载模板文件，按文件内“示例”格式添加试题信息后保存并上传文件。</p>        
	<div class="modal-footer">
	    <button type="button" class="btn btn-primary" onclick="uploaD('update_unitPortrait','file',12,'xls')">上传文件</button>  
	</div>
</div>

<div id="upload" style="display: none;">
	<button id="upload_file" onclick="uploaD('upload_file','file',12,'xls')" type="button" class="btn btn-primary center" style="width:500px;margin-left:50px;">上传文件</button>
	...
	<div class="modal-footer">
	    ...
	    <button type="button" class="btn btn-primary" onclick="detection(this);">文件检测</button> 
	</div>
</div>
