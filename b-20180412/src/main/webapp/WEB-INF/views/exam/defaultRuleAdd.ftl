...
<form id="addForm" method="post" class="form-horizontal" role="form" action="/examRule/do_add_default_rule">

    <div>
		<span style="margin-bottom: 15px;">练习类型：<select id="ruleType" name="ruleType" >
	...
	<table class="table table-striped table-bordered table-hover">
        ...
        <tr class="success">
            ...
            <#list keguan as type>
                <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumA chaptersumⅠ sumtype${type.id}" name="chaptersum_-1_${type.id}_A_Ⅰ" id="sum_-1_${type.id}_A_Ⅰ" /></td>
                <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumB chaptersumⅠ sumtype${type.id}" name="chaptersum_-1_${type.id}_B_Ⅰ" id="sum_-1_${type.id}_B_Ⅰ"  /></td>
                <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumC chaptersumⅠ sumtype${type.id}" name="chaptersum_-1_${type.id}_C_Ⅰ" id="sum_-1_${type.id}_C_Ⅰ" /></td>
            </#list>
            <#list zhuguan as type>
                <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumA chaptersumⅠ sumtype${type.id}" name="chaptersum_-1_${type.id}_A_Ⅰ" id="sum_-1_${type.id}_A_Ⅰ" /></td>
                <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumB chaptersumⅠ sumtype${type.id}" name="chaptersum_-1_${type.id}_B_Ⅰ" id="sum_-1_${type.id}_B_Ⅰ"  /></td>
        ...
        <tr class="success">
            ...
            <#list keguan as type>
                <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumA chaptersumⅡ sumtype${type.id}" name="chaptersum_-1_${type.id}_A_Ⅱ" id="sum_-1_${type.id}_A_Ⅱ" /></td>
                <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumB chaptersumⅡ sumtype${type.id}" name="chaptersum_-1_${type.id}_B_Ⅱ" id="sum_-1_${type.id}_B_Ⅱ" /></td>
                <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumC chaptersumⅡ sumtype${type.id}" name="chaptersum_-1_${type.id}_C_Ⅱ" id="sum_-1_${type.id}_C_Ⅱ" /></td>
            </#list>
            <#list zhuguan as type>
                <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumA chaptersumⅡ sumtype${type.id}" name="chaptersum_-1_${type.id}_A_Ⅱ" id="sum_-1_${type.id}_A_Ⅱ" /></td>
                <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumB chaptersumⅡ sumtype${type.id}" name="chaptersum_-1_${type.id}_B_Ⅱ" id="sum_-1_${type.id}_B_Ⅱ" /></td>
        ...
        <tr class="success">
            ...
            <#list keguan as type>
                <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumA chaptersumⅢ sumtype${type.id}" name="chaptersum_-1_${type.id}_A_Ⅲ" id="sum_-1_${type.id}_A_Ⅲ" /></td>
                <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumB chaptersumⅢ sumtype${type.id}" name="chaptersum_-1_${type.id}_B_Ⅲ" id="sum_-1_${type.id}_B_Ⅲ" /></td>
                <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumC chaptersumⅢ sumtype${type.id}" name="chaptersum_-1_${type.id}_C_Ⅲ" id="sum_-1_${type.id}_C_Ⅲ" /></td>
            </#list>
            <#list zhuguan as type>
                <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumA chaptersumⅢ sumtype${type.id}" name="chaptersum_-1_${type.id}_A_Ⅲ" id="sum_-1_${type.id}_A_Ⅲ" /></td>
                <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumB chaptersumⅢ sumtype${type.id}" name="chaptersum_-1_${type.id}_B_Ⅲ" id="sum_-1_${type.id}_B_Ⅲ" /></td>
