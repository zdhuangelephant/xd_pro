...
<form id="editForm" method="post" class="form-horizontal" role="form" action="/examRule/do_edit_default_rule">
...
<tr class="success">
    ...
    <#list keguan as type>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumA chaptersumⅠ sumtype${type.id}" name="chaptersum_-1_${type.id}_A_Ⅰ" id="sum_-1_${type.id}_A_Ⅰ" value="<#assign key='chaptersum_-1_'+type.id+'_A_Ⅰ'>${numMap[key]}"/></td>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumB chaptersumⅠ sumtype${type.id}" name="chaptersum_-1_${type.id}_B_Ⅰ" id="sum_-1_${type.id}_B_Ⅰ" value="<#assign key='chaptersum_-1_'+type.id+'_B_Ⅰ'>${numMap[key]}"/></td>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumC chaptersumⅠ sumtype${type.id}" name="chaptersum_-1_${type.id}_C_Ⅰ" id="sum_-1_${type.id}_C_Ⅰ" value="<#assign key='chaptersum_-1_'+type.id+'_C_Ⅰ'>${numMap[key]}"/></td>
    </#list>
    <#list zhuguan as type>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumA chaptersumⅠ sumtype${type.id}" name="chaptersum_-1_${type.id}_A_Ⅰ" id="sum_-1_${type.id}_A_Ⅰ" value="<#assign key='chaptersum_-1_'+type.id+'_A_Ⅰ'>${numMap[key]}"/></td>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumB chaptersumⅠ sumtype${type.id}" name="chaptersum_-1_${type.id}_B_Ⅰ" id="sum_-1_${type.id}_B_Ⅰ" value="<#assign key='chaptersum_-1_'+type.id+'_B_Ⅰ'>${numMap[key]}"/></td>
...
<tr class="success">
    ...
    <#list keguan as type>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumA chaptersumⅡ sumtype${type.id}" name="chaptersum_-1_${type.id}_A_Ⅱ" id="sum_-1_${type.id}_A_Ⅱ" value="<#assign key='chaptersum_-1_'+type.id+'_A_Ⅱ'>${numMap[key]}"/></td>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumB chaptersumⅡ sumtype${type.id}" name="chaptersum_-1_${type.id}_B_Ⅱ" id="sum_-1_${type.id}_B_Ⅱ" value="<#assign key='chaptersum_-1_'+type.id+'_B_Ⅱ'>${numMap[key]}"/></td>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumC chaptersumⅡ sumtype${type.id}" name="chaptersum_-1_${type.id}_C_Ⅱ" id="sum_-1_${type.id}_C_Ⅱ" value="<#assign key='chaptersum_-1_'+type.id+'_C_Ⅱ'>${numMap[key]}"/></td>
    </#list>
    <#list zhuguan as type>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumA chaptersumⅡ sumtype${type.id}" name="chaptersum_-1_${type.id}_A_Ⅱ" id="sum_-1_${type.id}_A_Ⅱ" value="<#assign key='chaptersum_-1_'+type.id+'_A_Ⅱ'>${numMap[key]}"/></td>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumB chaptersumⅡ sumtype${type.id}" name="chaptersum_-1_${type.id}_B_Ⅱ" id="sum_-1_${type.id}_B_Ⅱ" value="<#assign key='chaptersum_-1_'+type.id+'_B_Ⅱ'>${numMap[key]}"/></td>
...
<tr class="success">
    ...
    <#list keguan as type>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumA chaptersumⅢ sumtype${type.id}" name="chaptersum_-1_${type.id}_A_Ⅲ" id="sum_-1_${type.id}_A_Ⅲ" value="<#assign key='chaptersum_-1_'+type.id+'_A_Ⅲ'>${numMap[key]}"/></td>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumB chaptersumⅢ sumtype${type.id}" name="chaptersum_-1_${type.id}_B_Ⅲ" id="sum_-1_${type.id}_B_Ⅲ" value="<#assign key='chaptersum_-1_'+type.id+'_B_Ⅲ'>${numMap[key]}"/></td>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumC chaptersumⅢ sumtype${type.id}" name="chaptersum_-1_${type.id}_C_Ⅲ" id="sum_-1_${type.id}_C_Ⅲ" value="<#assign key='chaptersum_-1_'+type.id+'_C_Ⅲ'>${numMap[key]}"/></td>
    </#list>
    <#list zhuguan as type>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumA chaptersumⅢ sumtype${type.id}" name="chaptersum_-1_${type.id}_A_Ⅲ" id="sum_-1_${type.id}_A_Ⅲ" value="<#assign key='chaptersum_-1_'+type.id+'_A_Ⅲ'>${numMap[key]}"/></td>
        <td><input type="text" data-score="${type.score}" class="editorTd chaptersum chaptersumB chaptersumⅢ sumtype${type.id}" name="chaptersum_-1_${type.id}_B_Ⅲ" id="sum_-1_${type.id}_B_Ⅲ" value="<#assign key='chaptersum_-1_'+type.id+'_B_Ⅲ'>${numMap[key]}"/></td>
