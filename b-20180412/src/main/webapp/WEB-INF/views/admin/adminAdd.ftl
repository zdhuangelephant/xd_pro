...
<form id="addForm" method="post" class="form-horizontal" role="form" action="/admin/addAdmin">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input name="password" type="password"  class="dfinput" datatype="*8-16"
                   sucmsg=" " nullmsg="请输入密码"/>
        </div>
        <div class="col-sm-6" style="color: red;"></div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input name="repeatPassword" value="" type="password" class="dfinput" sucmsg=" "
                   datatype="*" recheck="password" nullmsg="请确认密码"
	...
	<div class="form-group">
        ...
        <div class="col-sm-3">
            <input name="merchant" type="text" class="dfinput"
                   datatype="s2-8" sucmsg=" "  nullmsg="请输入学习机构 "/>
        </div>
        <div class="col-sm-6" style="color: red;"></div>
    </div>
