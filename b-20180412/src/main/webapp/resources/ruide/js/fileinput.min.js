...
!function (e) {
    ...
    var t, i, a, n, r, l, o, s, d, c, p, u, f, m, g, v, h, w, b, _, C, x, y, T, F, k, E, $, S, I, P, D, z, A, U, j, L, Z, B, O, R, M, N, H, q, W, V, K, G, X, Y, J, Q, ee, te, ie, ae, ne, re, le, oe, se, de, ce, pe, ue, fe, me;
    t = ".fileinput", i = "kvFileinputModal", a = 'style="width:{width};height:{height};"', n = '<param name="controller" value="true" />\n<param name="allowFullScreen" value="true" />\n<param name="allowScriptAccess" value="always" />\n<param name="autoPlay" value="false" />\n<param name="autoStart" value="false" />\n<param name="quality" value="high" />\n', r = '<div class="file-preview-other">\n<span class="{previewFileIconClass}">{previewFileIcon}</span>\n</div>', l = window.URL || window.webkitURL, o = function (e, t, i) {
        ...
        data: {}, init: function (e) {
            var t = e.initialPreview, i = e.id;
            t.length > 0 && !ne(t) && (t = t.split(e.initialPreviewDelimiter)), c.data[i] = {
                content: t,
            ...
            var l, o, s = e.extend(!0, {}, c.data[t]);
            if (i && i.length && (ne(i) || (i = i.split(s.delimiter)), o = i.filter(function (e) {
                    return null !== e
                }), o.length)) {
            ...
            var t, i = "", a = c.data[e], n = c.count(e, !0);
            ...
            var n = c.data[e];
            if (i = void 0 === i ? !0 : i, 0 === n.config.length || ae(n.config[t]))return "";
            var r = n.config[t], l = re("caption", r), o = re("width", r, "auto"), s = re("url", r, !1), d = re("key", r, null), p = re("showDelete", r, !0), u = re("showZoom", r, n.showZoom), f = re("showDrag", r, n.showDrag), m = s === !1 && i, g = n.isDelete ? n.actions(!1, p, u, f, m, s, d) : "", v = n.footer.replace(/\{actions}/g, g);
        ...
        pdf: L + V + Z,
        other: L + K + Z
    }, Q = ["image", "html", "text", "video", "audio", "flash", "pdf", "object"], te = {
        image: {
            width: "auto",
            height: "160px"
        },
        ...
        if (i >= e.length)for (var a = i - e.length; a-- + 1;)e.push(void 0);
        ...
        constructor: me, _init: function (t) {
            var i, a = this, n = a.$element;
            ...
            e && i.length && (i.html(t.errorCloseButton + e), d(i.find(".kv-error-close"), "click", function () {
                i.fadeOut("slow")
            }))
            ...
            var a = this, n = a.$errorContainer, r = i || "fileuploaderror", l = t && t.id ? '<li data-file-id="' + t.id + '">' + e + "</li>" : "<li>" + e + "</li>";
            ...
            var a = this, n = a.$errorContainer, r = i || "fileerror";
            return t = t || {}, t.reader = a.reader, a._addError(e), n.fadeIn(800), a._raise(r, [t, e]), a.isUploadable || a._clearFileInput(), a.$container.removeClass("file-input-new"), g(a.$container, "has-error"), a.$btnUpload.attr("disabled", !0), !0
        }, _noFilesError: function (e) {
            var t = this, i = t.minFileCount > 1 ? t.filePlural : t.fileSingle, a = t.msgFilesTooLess.replace("{n}", t.minFileCount).replace("{files}", i), n = t.$errorContainer;
            ...
            var n = this, r = e.trim(i + ""), l = "." === r.slice(-1) ? "" : ".", o = void 0 !== t.responseJSON && void 0 !== t.responseJSON.error ? t.responseJSON.error : t.responseText;
            ...
            var t, i, a, n, r = this;
            for (n = 0; n < Q.length; n += 1)if (a = Q[n], t = re(a, r.fileTypeSettings, ie[a]), i = t(e.type, e.name) ? a : "", !ae(i))return i;
            return "other"
        }, _parseFilePreviewIcon: function (t, i) {
            var a, n, r = this, l = r.previewFileIcon;
            ...
            var t, i = this;
            i.isClickable && (t = i.isUploadable ? i.$dropZone : i.$preview.find(".file-default-preview"), g(t, "clickable"), t.attr("tabindex", -1), d(t, "click", function (a) {
                var n = e(a.target);
            ...
            t.isUploadable && t.dropZoneEnabled && t.showPreview && (d(i, "dragenter dragover", e.proxy(t._zoneDragEnter, t)), d(i, "dragleave", e.proxy(t._zoneDragLeave, t)), d(i, "drop", e.proxy(t._zoneDrop, t)), d(e(document), "dragenter dragover drop", t._zoneDragDropInit))
        }, _zoneDragDropInit: function (e) {
            e.stopPropagation(), e.preventDefault()
        }, _zoneDragEnter: function (t) {
            var i = this, a = e.inArray("Files", t.originalEvent.dataTransfer.types) > -1;
            ...
            var t, i = this, a = i.$container.find(".fileinput-upload"), n = !a.hasClass("disabled") && ae(a.attr("disabled"));
            ...
            var e = this, t = e.$element, i = t.get(0).files;
            return i && e.minFileCount > 0 && e._getFileCount(i.length) < e.minFileCount ? (e._noFilesError({}), !1) : !e._abort({})
        }, _clearPreview: function () {
            var e = this, t = e.showUploadedThumbs ? e.$preview.find(".file-preview-frame:not(.file-preview-success)") : e.$preview.find(".file-preview-frame");
            t.remove(), e.$preview.find(".file-preview-frame").length && e.showPreview || e._resetUpload(), e._validateDefaultPreview()
        }, _initSortable: function () {
            var t, i, a = this, n = a.$preview;
            window.Sortable && (t = n.find(".file-initial-thumbs"), i = {
                handle: ".drag-handle-init",
                dataIdAttr: "data-preview-id",
                draggable: ".file-preview-initial",
                onSort: function (t) {
                    var i = t.oldIndex, n = t.newIndex;
                    a.initialPreview = fe(a.initialPreview, i, n), a.initialPreviewConfig = fe(a.initialPreviewConfig, i, n), c.init(a), a._raise("filesorted", {
            ...
            return c.count(i.id) ? (t = c.out(i.id), a = e && i.initialCaption ? i.initialCaption : t.caption, i.$preview.html(t.content), i._setCaption(a), i._initSortable(), void(ae(t.content) || i.$container.removeClass("file-input-new"))) : (i._clearPreview(), void(e ? i._setCaption(a) : i._initCaption()))
        }, _getZoomButton: function (e) {
            var t = this, i = t.previewZoomButtonIcons[e], a = t.previewZoomButtonClasses[e], n = ' title="' + (t.previewZoomButtonTitles[e] || "") + '" ', r = n + ("close" === e ? ' data-dismiss="modal" aria-hidden="true"' : "");
            ...
            var t = this, i = t.$modal, a = function (e) {
                return {sourceEvent: e, previewId: i.data("previewId"), modal: i}
            };
            i.on(e + ".bs.modal", function (n) {
                var r = i.find(".btn-fullscreen"), l = i.find(".btn-borderless");
                t._raise("filezoom" + e, a(n)), "shown" === e && (l.removeClass("active").attr("aria-pressed", "false"), r.removeClass("active").attr("aria-pressed", "false"), i.hasClass("file-zoom-fullscreen") && (t._maximizeZoomDialog(), pe() ? r.addClass("active").attr("aria-pressed", "true") : l.addClass("active").attr("aria-pressed", "true")))
            })
        }, _initZoom: function () {
            var t, a = this, n = a._getLayoutTemplate("modalMain"), r = "#" + i;
            ...
            var t, i, a = this, n = a.$modal.data("previewId") || "", r = a.$preview.find(".file-preview-frame").toArray(), l = r.length, o = a.$modal.find(".btn-prev"), s = a.$modal.find(".btn-next");
            ...
            var t = this, i = t.$modal, a = i.find(".modal-header:visible"), n = i.find(".modal-footer:visible"), r = i.find(".modal-body"), l = e(window).height(), o = 0;
            ...
            var t = this, i = t.$modal, a = i.find(".btn-fullscreen"), n = i.find(".btn-borderless");
            if (i.hasClass("file-zoom-fullscreen"))ue(!1), e ? a.hasClass("active") || (i.removeClass("file-zoom-fullscreen"), t._resizeZoomDialog(!0), n.hasClass("active") && n.removeClass("active").attr("aria-pressed", "false")) : a.hasClass("active") ? a.removeClass("active").attr("aria-pressed", "false") : (i.removeClass("file-zoom-fullscreen"), t.$modal.find(".kv-zoom-body").css("height", t.zoomModalHeight)); else {
                if (!e)return void t._maximizeZoomDialog();
                ue(!0)
            }
            i.focus()
        }, _setZoomContent: function (t, i) {
            var a, n, r, l, o, s, c, p, u = this, f = t.attr("id"), m = u.$modal, v = m.find(".btn-prev"), h = m.find(".btn-next"), w = m.find(".btn-fullscreen"), b = m.find(".btn-borderless"), _ = m.find(".btn-toggleheader");
            n = t.data("template") || "generic", a = t.find(".kv-file-content"), r = a.length ? a.html() : "", l = t.find(".file-footer-caption").text() || "", m.find(".kv-zoom-title").html(l), o = m.find(".kv-zoom-body"), i ? (p = o.clone().insertAfter(o), o.html(r).hide(), p.fadeOut("fast", function () {
                ...
                var e, t = m.find(".modal-header"), i = m.find(".modal-body .floating-buttons"), a = t.find(".kv-zoom-actions"), n = function (e) {
                    var i = u.$modal.find(".kv-zoom-body"), a = u.zoomModalHeight;
            ...
            var a, n, r, l = this, o = l.$modal.find(".kv-zoom-actions .btn-" + t), s = l.$preview.find(".file-preview-frame").toArray(), d = s.length;
            if (!o.attr("disabled")) {
                for (n = 0; d > n; n++)if (e(s[n]).attr("id") === i) {
                    r = "prev" === t ? n - 1 : n + 1;
                    break
                }
            ...
            var t = this, i = t.deleteExtraData || {}, a = function () {
            ...
            t._initZoomButton(), t.$preview.find(".kv-file-remove").each(function () {
                var n = e(this), r = n.data("url") || t.deleteUrl, l = n.data("key");
                if (!ae(r) && void 0 !== l) {
                    var o, s, p, u, f = n.closest(".file-preview-frame"), m = c.data[t.id], v = f.data("fileindex");
                    v = parseInt(v.replace("init_", "")), p = ae(m.config) && ae(m.config[v]) ? null : m.config[v], u = ae(p) || ae(p.extra) ? i : p.extra, "function" == typeof u && (u = u()), s = {
                        id: n.attr("id"),
                        key: l,
                        extra: u
                    }, o = e.extend(!0, {}, {
                        ...
                        success: function (e, i, r) {
                            var o, d;
                            return ae(e) || ae(e.error) ? (c.unset(t.id, v), o = c.count(t.id), d = o > 0 ? t._getMsgSelected(o) : "", t._raise("filedeleted", [l, r, u]), t._setCaption(d), f.removeClass("file-uploading").addClass("file-deleted"), void f.fadeOut("slow", function () {
            ...
            var t, i, a, n = this, r = n.$element;
            ae(r.val()) || (n.isIE9 || n.isIE10 ? (t = r.closest("form"), i = e(document.createElement("form")), a = e(document.createElement("div")), r.before(a), t.length ? t.after(i) : a.after(i), i.append(r).trigger("reset"), a.before(r).remove(), i.remove()) : r.val(""), n.fileInputCleared = !0)
            ...
            var e, t, i = this;
            c.count(i.id) ? (e = c.out(i.id), i.$preview.html(e.content), t = i.initialCaption ? i.initialCaption : e.caption, i._setCaption(t)) : (i._clearPreview(), i._initCaption()), i.showPreview && (i._initZoom(), i._initSortable())
            ...
            return e.upload && e.upload.addEventListener("progress", function (e) {
                var n = 0, r = e.loaded || e.position, l = e.total;
            ...
            t.showPreview && t._getThumbs(".file-preview-success").each(function () {
                var i = e(this), a = i.find(".kv-file-remove");
                a.removeAttr("disabled"), d(a, "click", function () {
                    var e = t._raise("filesuccessremove", [i.attr("id"), i.data("fileindex")]);
                    de(i), e !== !1 && i.fadeOut("slow", function () {
            ...
            var a = this, n = a._getExtraData(t, i);
            0 !== n.length && e.each(n, function (e, t) {
                a.formdata.append(e, t)
            })
        }, _uploadSingle: function (t, i, a) {
            var n, r, l, o, s, d, p, u, f, m, v = this, h = v.getFileStack().length, w = new FormData, b = v.previewInitId + "-" + t, _ = v.filestack.length > 0 || !e.isEmptyObject(v.uploadExtraData), C = {
                id: b,
                index: t
            };
            v.formdata = w, v.showPreview && (r = e("#" + b + ":not(.file-preview-initial)"), o = r.find(".kv-file-upload"), s = r.find(".kv-file-remove"), e("#" + b).find(".file-thumb-progress").removeClass("hide")), 0 === h || !_ || o && o.hasClass("disabled") || v._abort(C) || (m = function (e, t) {
            ...
            var t, i, a, n, r, l = this, o = l.filestack, s = o.length, d = {}, c = l.filestack.length > 0 || !e.isEmptyObject(l.uploadExtraData);
            l.formdata = new FormData, 0 !== s && c && !l._abort(d) && (r = function () {
                ...
                var n = l._getOutData(a, t), o = l._getThumbs(":not(.file-preview-error)"), s = 0, d = ae(t) || ae(t.errorkeys) ? [] : t.errorkeys;
                ae(t) || ae(t.error) ? (l._raise("filebatchuploadsuccess", [n]), r(), l.showPreview ? (o.each(function () {
                    var t = e(this), i = t.find(".kv-file-upload");
                    ...
                    var t = e(this), i = t.find(".kv-file-remove"), a = t.find(".kv-file-upload");
                ...
                var n = l._getOutData(t), r = l._parseError(t, a);
            ...
            n.formdata = new FormData, n._abort(r) || (e = function (e) {
                ...
                var a = n._getOutData(e), l = n._parseError(e, i);
            ...
            t.showPreview && (t._initZoomButton(), t.$preview.find(".kv-file-remove").each(function () {
                var i, a, n, r, l = e(this), o = l.closest(".file-preview-frame"), s = o.attr("id"), p = o.attr("data-fileindex");
                d(l, "click", function () {
                    return r = t._raise("filepreremove", [s, p]), r !== !1 && t._validateMinCount() ? (i = o.hasClass("file-preview-error"), de(o), void o.fadeOut("slow", function () {
                        ...
                        var r = t.getFileStack(!0), l = c.count(t.id), d = r.length, u = t.showPreview && t.$preview.find(".file-preview-frame").length;
                ...
                var i = e(this);
                d(i, "click", function () {
                    var e = i.closest(".file-preview-frame"), a = e.attr("data-fileindex");
            ...
            var i, a, n, r = this, l = r.fileSizeGetter;
            ...
            if (this.showPreview) {
                var l, o = this, s = o._parseFileType(i), d = i ? i.name : "", c = o.slug(d), p = o.allowedPreviewTypes, u = o.allowedPreviewMimeTypes, f = o.$preview, m = p && p.indexOf(s) >= 0, g = f.find(".file-live-thumbs"), v = "text" === s || "html" === s || "image" === s ? a.target.result : r, h = u && -1 !== u.indexOf(i.type);
            ...
            var i, a = this, n = a.$element, r = a.$preview, s = a.reader, d = a.$previewContainer, c = a.$previewStatus, p = a.msgLoading, u = a.msgProgress, f = a.previewInitId, m = t.length, g = a.fileTypeSettings, v = a.filestack.length, h = a.maxFilePreviewSize && parseFloat(a.maxFilePreviewSize), w = r.length && (!h || isNaN(h)), b = function (n, r, l, o) {
                var s = e.extend(!0, {}, a._getOutData({}, {}, t), {id: l, index: o}), d = {
                    id: l,
                    index: o,
                    file: r,
                    files: t
            ...
            a.loadedImages = [], a.totalImagesCount = 0, e.each(t, function (e, t) {
                ...
                if (ae(n.attr("multiple")) && (m = 1), e >= m)return a.isUploadable && a.filestack.length > 0 ? a._raise("filebatchselected", [a.getFileStack()]) : a._raise("filebatchselected", [t]), d.removeClass("file-thumb-loading"), void c.html("");
                var _, C, x, y, T, F, k, E = v + e, $ = f + "-" + E, S = t[e], I = a.slug(S.name), P = (S.size || 0) / 1e3, D = "", z = l.createObjectURL(S), A = 0, U = a.allowedFileTypes, j = ae(U) ? "" : U.join(", "), L = a.allowedFileExtensions, Z = ae(L) ? "" : L.join(", ");
                if (ae(L) || (D = new RegExp("\\.(" + L.join("|") + ")$", "i")), P = P.toFixed(2), a.maxFileSize > 0 && P > a.maxFileSize)return T = a.msgSizeTooLarge.replace("{name}", I).replace("{size}", P).replace("{maxSize}", a.maxFileSize), void(a.isError = b(T, S, $, e));
                if (!ae(U) && ne(U)) {
                ...
                return 0 !== A || ae(L) || !ne(L) || ae(D) || (k = o(I, D), A += ae(k) ? 0 : k.length, 0 !== A) ? a.showPreview ? !w && P > h ? (a.addToStack(S), d.addClass("file-thumb-loading"), a._previewDefault(S, $), a._initFileActions(), a._updateFileDetails(m), void i(e + 1)) : (r.length && void 0 !== FileReader ? (c.html(p.replace("{index}", e + 1).replace("{files}", m)), d.addClass("file-thumb-loading"), s.onerror = function (e) {
                    ...
                    if (t.lengthComputable) {
                        var i = t.loaded / t.total * 100, a = Math.ceil(i);
            ...
            var t = this, i = t.$element, a = t.getFileStack(), n = s(9) && ce(i.val()) || i[0].files[0] && i[0].files[0].name || a.length && a[0].name || "", r = t.slug(n), l = t.isUploadable ? a.length : e, o = c.count(t.id) + l, d = l > 1 ? t._getMsgSelected(o) : r;
            ...
            var i = this;
            if (i.showPreview) {
                var a = "indicator" + t, n = a + "Title", r = "file-preview-" + t.toLowerCase(), l = e.find(".file-upload-indicator"), o = i.fileActionSettings;
            ...
            var a = this, n = Math.min(e, 100), r = 100 > n ? a.progressTemplate : i ? a.progressErrorTemplate : a.progressCompleteTemplate;
            ...
            var e = this, t = e.isUploadable ? e.getFileStack().length : e.$element.get(0).files.length;
            ...
            var o, s, d, c, p = this, u = "Small" === t ? "min" : "max", f = p[u + "Image" + r];
            !ae(f) && i.length && (d = i[0], s = "Width" === r ? d.naturalWidth || d.width : d.naturalHeight || d.height, c = "Small" === t ? s >= f : f >= s, c || (o = p["msgImage" + r + t].replace("{name}", n).replace("{size}", f), p._showUploadError(o, l), p._setPreviewError(a, e, null)))
        }, _validateImage: function (e, t, i, a) {
            var n, r, o, s = this, c = s.$preview, p = c.find("#" + t), u = p.find("img");
            i = i || "Untitled", u.length && d(u, "load", function () {
                r = p.width(), o = c.width(), r > o && (u.css("width", "100%"), p.css("width", "97%")), n = {
                    ind: e,
                    id: t
            ...
            var n, r, l = this, o = e.naturalWidth, s = e.naturalHeight, d = 1, c = l.maxImageWidth || o, p = l.maxImageHeight || s, u = o && s, f = l.imageCanvas, m = l.imageCanvasContext;
            if (!u)return !1;
            if (o === c && s === p)return !0;
            ...
            var a, n, r, l, o = this, s = o.getFileStack();
            if (o.$caption.length) {
            ...
            var t = this, i = e(document.createElement("div")).attr({"class": "file-input file-input-new"}).html(t._renderMain());
            ...
            var t = this, i = t._getLayoutTemplate("btnDefault"), a = t[e + "Class"], n = t[e + "Title"], r = t[e + "Icon"], l = t[e + "Label"], o = t.isDisabled ? " disabled" : "", s = "button";
            switch (e) {
                case"remove":
            ...
            return a += "browse" === e ? " btn-file" : " fileinput-" + e + " fileinput-" + e + "-button", ae(l) || (l = ' <span class="' + t.buttonLabelClass + '">' + l + "</span>"), i.replace("{type}", s).replace("{css}", a).replace("{title}", n).replace("{status}", o).replace("{icon}", r).replace("{label}", l)
            ...
            var n, r = this, l = r.fileActionSettings, o = l.showRemove, s = l.showDrag, d = l.showUpload, c = l.showZoom, p = r._getLayoutTemplate("footer"), u = a ? l.indicatorError : l.indicatorNew, f = a ? l.indicatorErrorTitle : l.indicatorNewTitle;
            return t = r._getSize(t), n = r.isUploadable ? p.replace(/\{actions}/g, r._renderFileActions(d, o, c, s, !1, !1, !1)).replace(/\{caption}/g, e).replace(/\{size}/g, t).replace(/\{width}/g, i).replace(/\{progress}/g, r._renderThumbProgress()).replace(/\{indicator}/g, u).replace(/\{indicatorTitle}/g, f) : p.replace(/\{actions}/g, r._renderFileActions(!1, !1, c, s, !1, !1, !1)).replace(/\{caption}/g, e).replace(/\{size}/g, t).replace(/\{width}/g, i).replace(/\{progress}/g, "").replace(/\{indicator}/g, u).replace(/\{indicatorTitle}/g, f), n = se(n, r.previewThumbTags)
        }, _renderFileActions: function (e, t, i, a, n, r, l, o) {
            if (!(e || t || i || a))return "";
            var s, d = this, c = r === !1 ? "" : ' data-url="' + r + '"', p = l === !1 ? "" : ' data-key="' + l + '"', u = "", f = "", m = "", g = "", v = d._getLayoutTemplate("actions"), h = d.fileActionSettings, w = d.otherActionButtons.replace(/\{dataKey}/g, p), b = n ? h.removeClass + " disabled" : h.removeClass;
            ...
            if (!i.isUploadable && ae(a.val()) && i.fileInputCleared)return void(i.fileInputCleared = !1);
            i.fileInputCleared = !1;
            var n, r, l, o, s, d, p = arguments.length > 1, u = i.isUploadable, f = 0, m = p ? t.originalEvent.dataTransfer.files : a.get(0).files, g = i.filestack.length, v = ae(a.attr("multiple")), h = v && g > 0, w = 0, b = function (t, a, n, r) {
                var l = e.extend(!0, {}, i._getOutData({}, {}, m), {id: n, index: r}), o = {
                    id: n,
                    index: r,
                    file: a,
                    files: m
            ...
            if (i.reader = null, i._resetUpload(), i._hideFileIcon(), i.isUploadable && i.$container.find(".file-drop-zone ." + i.dropZoneTitleClass).remove(), p)for (n = []; m[f];)o = m[f], o.type || o.size % 4096 !== 0 ? n.push(o) : w++, f++; else n = void 0 === t.target.files ? t.target && t.target.value ? [{name: t.target.value.replace(/^.+\\/, "")}] : [] : t.target.files;
            ...
            t._getThumbs().each(function () {
                var r = e(this), l = r.attr("data-fileindex"), o = t.filestack[l];
                -1 !== l && (void 0 !== o ? (a[i] = o, n[i] = t._getFileName(o), r.attr({
                    id: t.previewInitId + "-" + i,
                    "data-fileindex": i
                }), i++) : r.attr({id: "uploaded-" + le(), "data-fileindex": "-1"}))
            ...
            var t, i, a, n = this, r = n.getFileStack().length, l = {}, o = !e.isEmptyObject(n._getExtraData());
        ...
        if (u() || s(9)) {
            var i = Array.apply(null, arguments), a = [];
            switch (i.shift(), this.each(function () {
                var n, r = e(this), l = r.data("fileinput"), o = "object" == typeof t && t, s = o.theme || r.data("theme"), d = {}, c = {}, p = o.language || r.data("language") || "en";
                l || (s && (c = e.fn.fileinputThemes[s] || {}), "en" === p || ae(e.fn.fileinputLocales[p]) || (d = e.fn.fileinputLocales[p] || {}), n = e.extend(!0, {}, e.fn.fileinput.defaults, c, e.fn.fileinputLocales.en, d, o, r.data()), l = new me(this, n), r.data("fileinput", l)), "string" == typeof t && a.push(l[t].apply(l, i))
            }), a.length) {
                case 0:
                    return this;
                case 1:
    ...
    }, e.fn.fileinput.Constructor = me, e(document).ready(function () {
