...
public class MessagePushInfo {
  ...
  public String toString(){
    String str = "messageType:"+this.messageType+",targetType:"+this.targetType+",messageContent:"+this.messageContent+
        ",noticeContent:"+this.noticeContent+",spreadRange:"+this.spreadRange+",alias:"+this.alias+
        ",tags:"+this.tags+",registrationIds:"+this.registrationIds+",messagedbid:"+this.messagedbid;
    return str;
  }
