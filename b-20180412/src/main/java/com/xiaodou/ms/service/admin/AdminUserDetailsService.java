...
public class AdminUserDetailsService implements UserDetailsManager {
  ...
  public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
    ...
    user =
      new AdminUser(admin, enables, accountNonExpired, credentialsNonExpired, accountNonLocked, grantedAuthorities);
    return user;
  }
  ...
  private Set<GrantedAuthority> getGrantedAuthoritys(Admin admin) {
    ...
    List<Role> roles = this.adminService.queryAdminRoles(admin.getId());
