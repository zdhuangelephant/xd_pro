...
<head>
<meta charset="UTF-8">
<title>${paperDetail.title }_学业论文_瑞德在线</title>
<meta name="description" content="${paperDetail.htmlContent}">
...
<body>
		...
		<div class="top">
			...
			<div class="top-left">
				...
				<div class="nav">
					<ul>
						<li><a href="/">首页</a></li>
						<li><a href="#" class="active">学业论文</a></li>
	...
	<div class="content-wrap">
		<div class="content">
			<div class="w1002">
				<div class="cont-left">
				<div class="bread">当前位置：<a href="/">首页</a>>><a href="#">学业论文</a>>><span>${paperDetail.title }</span></div>
				<#if paperDetail??>
					<div class="detail-content">
						<h1>${paperDetail.title }</h1>
						<div class="detail-info">
							<p>
								<span>作者：${paperDetail.author } 发布时间:
									${paperDetail.publishTime?string("yyyy-MM-dd") } </span>
							</p>
						</div>
						<#if (paperDetail.contentImage)??> 
							<div class="detail-imgage">
								<img src="${paperDetail.contentImage }" alt="${paperDetail.title }"> 
							</div>
						</#if> 
						<div class="detail-img">
							${paperDetail.content }
						</div>
						<p class="zan"><span>阅读（${paperDetail.readQuantity }）</span><span><a id="thumbsId" href="javascript:void(0)" onclick="doThumbs('${paperDetail.id}','${paperDetail.thumbNums}','1')">赞(${paperDetail.thumbNums})</a></span></p>
					</div>
					<#else>
