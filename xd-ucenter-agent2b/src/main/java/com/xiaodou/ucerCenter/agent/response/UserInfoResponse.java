...
import com.xiaodou.ucerCenter.agent.enums.UserPraiseEnum;
...
public class UserInfoResponse extends BaseResultInfo {
  ...
  public static class UserInfo extends StUserInfoResponse {
    ...
    public UserInfo getUserInfo(UserModel model) {
      ...
      if (null != model.getLearnDays()) this.setLearnDays(model.getLearnDays());
      if (null != model.getLoginDays()) this.setLoginDays(model.getLoginDays());
      return this;
    }
