 ...
 * @version 1.0
 */
public class OrderAlarm extends AlarmEntityImpl {

  private String eventModule = "xd-wallet";
  private String eventName = "order-fail";
  private String messageInfo = "下单接口系统异常. %s";
  private String mailInfo = "下单接口系统异常. %s";

  public OrderAlarm(String message) {
