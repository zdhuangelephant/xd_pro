package com.xiaodou.st.dashboard.web.controller.message;
...
import com.xiaodou.st.dashboard.service.message.MqMessageService;
...
//      Class<?> asyncMessageServiceClass = MqMessageService.class;
      Class<?> asyncMessageServiceClass = MqMessageService.class;
      Method method = asyncMessageServiceClass.getMethod(pojo.getMessageName(), JMSGPojo.class);
