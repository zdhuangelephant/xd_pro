/**
 * jQuery pagination plugin v1.0 http://esimakin.github.io/twbs-pagination/
 * 
 * Copyright 2014, Eugene Simakin Released under Apache 2.0 license
		...
		setupEvents : function() {
			...
			this.$listContainer.find('li').each(function() {
				...
				if ($this.hasClass('disabled') || $this.hasClass('active'))
					return;
				$this.click(function() {
					//alert("page"+$this.data('page'));
					//alert("page"+parseInt($this.data('page'), 10));
					base.click(parseInt($this.data('page'), 10));
				});
			});
		},
