...
!function (e) {
    ...
    function o(e, t, i) {
        if (null == i && (null == t ? (i = e, e = null) : (i = t, t = null, e instanceof Array && (t = e, e = null))), null != i) {
            ...
            e ? s(e, t, i) : B[0] = {deps: t, factory: i}
        }
    }
        ...
        if (t && !m(e, M)) {
            ...
            C(i, function (i, n) {
                ...
                d && !P[d] ? (h.res && (l = {
                    ...
                    absId: d,
                    hard: a > n
                }, t.depMs.push(s), t.depMkv[d] = s, o.push(d))) : s = {absId: d}, a > n && t.factoryDeps.push(l || s)
        ...
        function i() {
            if (!n && a.state === F) {
                ...
                if (C(a.factoryDeps, function (e) {
                    ...
                    try {
                        var o = a.factory, r = "function" == typeof o ? o.apply(e, u(a.factoryDeps, {
                            require: a.require,
                            exports: a.exports,
                            module: a
                        })) : o;
    ...
    function f(t) {
        ...
        if (!R[t] && !z[t]) {
            R[t] = 1;
            var r = N.shim[t];
            r instanceof Array && (N.shim[t] = r = {deps: r});
            var s = r && (r.deps || []);
            s ? (C(s, function (e) {
                N.shim[e] || (N.shim[e] = {})
            }), D(s, i)) : i()
    ...
    function y(e, t) {
        ...
        function n(n) {
            ...
            n.load(s.res, a, i, r.call({id: e}))
        }

        if (!z[e]) {
            var o = Q[e];
            if (o)return void f(o);
            var s = W(e), l = {id: e, state: M};
    ...
    function v(e) {
        function i(i, a) {
            ...
            if (i instanceof Array) {
                var r = [], s = [];
                C(i, function (i, n) {
                    var a = W(i), o = L(a.mod, e), l = a.res, h = o;
                    if (l) {
                        var d = o + "!" + l;
    ...
    function W(e) {
        var t = e.split("!");
        return t[0] ? {mod: t[0], res: t[1]} : void 0
    }
    ...
    i.config = function (e) {
        if (e) {
            for (var t in N) {
                var i = e[t], n = N[t];
                if (i)if ("urlArgs" === t && "string" == typeof i)N.urlArgs["*"] = i; else if (n instanceof Array)n.push.apply(n, i); else if ("object" == typeof n)for (var a in i)n[a] = i[a]; else N[t] = i
            }
            _()
        }
    }, _();
    ...
    var a = e("./config"), o = e("zrender/tool/util"), r = e("zrender/tool/event"), s = {}, l = e("zrender/tool/env").canvasSupported, h = new Date - 0, d = {}, c = "_echarts_instance_";
    ...
    var m = e("zrender/config").EVENT, p = ["CLICK", "DBLCLICK", "MOUSEOVER", "MOUSEOUT", "DRAGSTART", "DRAGEND", "DRAGENTER", "DRAGOVER", "DRAGLEAVE", "DROP"];
    return i.prototype = {
        _init: function () {
            ...
            if (this._mergeGlobalConifg(t), !this._noDataCheck(t)) {
                ...
                var f = "IMG" + this.id, y = document.getElementById(f);
            ...
            function s() {
                if (c._zr) {
                    ...
                    c._messageCenter.dispatch(a.EVENT.REFRESH, null, {option: h}, c)
                }
            }
            ...
            for (var l = e instanceof Array ? e : [[e, t, i, n, r]], h = this.getOption(), d = this._optionRestore, c = this, m = 0, p = l.length; p > m; m++) {
                ...
                var u = d.series[e], V = i ? "unshift" : "push", U = i ? "pop" : "shift";
                if (u) {
                    var g = u.data, f = h.series[e].data;
                    if (g[V](t), f[V](t), n || (g[U](), t = f[U]()), null != r) {
                        ...
                        if (u.type === a.CHART_TYPE_PIE && (y = d.legend) && (b = y.data)) {
                            ...
                            if (b[V](r), _[V](r), !n) {
                                ...
                                -1 != x && b.splice(x, 1), x = o.indexOf(_, t.name), -1 != x && _.splice(x, 1)
                            }
            ...
            for (var l in n)d.addShape(new c({style: {x: n[l].left - a, y: n[l].top - o, image: n[l].img}}));
            d.render();
    ...
    function l(e, t, i) {
        if (e && t)if (e.forEach && e.forEach === u)e.forEach(t, i); else if (e.length === +e.length)for (var n = 0, a = e.length; a > n; n++)t.call(i, e[n], n, e); else for (var o in e)e.hasOwnProperty(o) && t.call(i, e[o], o, e)
    }
    ...
    return {inherits: s, clone: i, merge: a, getContext: o, indexOf: r, each: l, map: h, filter: d, bind: c}
    ...
    function e(e) {
        var t = this.os = {}, i = this.browser = {}, n = e.match(/Web[kK]it[\/]{0,1}([\d.]+)/), a = e.match(/(Android);?[\s\/]+([\d.]+)?/), o = e.match(/(iPad).*OS\s([\d_]+)/), r = e.match(/(iPod)(.*OS\s([\d_]+))?/), s = !o && e.match(/(iPhone\sOS)\s([\d_]+)/), l = e.match(/(webOS|hpwOS)[\s\/]([\d.]+)/), h = l && e.match(/TouchPad/), d = e.match(/Kindle\/([\d.]+)/), c = e.match(/Silk\/([\d._]+)/), m = e.match(/(BlackBerry).*Version\/([\d.]+)/), p = e.match(/(BB10).*Version\/([\d.]+)/), u = e.match(/(RIM\sTablet\sOS)\s([\d.]+)/), V = e.match(/PlayBook/), U = e.match(/Chrome\/([\d.]+)/) || e.match(/CriOS\/([\d.]+)/), g = e.match(/Firefox\/([\d.]+)/), f = e.match(/MSIE ([\d.]+)/), y = n && e.match(/Mobile\//) && !U, b = e.match(/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/) && !U, f = e.match(/MSIE\s([\d.]+)/);
    ...
    var c = function (i, n) {
        ...
        var a = this, h = this.storage, d = h.delFromMap;
    ...
    return c.prototype.getId = function () {
        ...
        if ("string" == typeof e && (e = this.storage.get(e)), e) {
            ...
            var c = e.__animators, m = this.animation.animate(r, {loop: a}).during(function () {
                o.modShape(e)
            }).done(function () {
    ...
    return t.prototype = {
        type: a.CHART_TYPE_ISLAND, _combine: function (t, i) {
            var n = e("zrender/tool/color"), a = e("../util/accMath"), r = a.accAdd(o.get(t, "value"), o.get(i, "value")), s = o.get(t, "name") + this._nameConnector + o.get(i, "name");
            ...
            var t = o.get(e, "name"), i = o.get(e, "value"), a = null != o.get(e, "series") ? o.get(e, "series").name : "", r = this.getFont(this.option.island.textStyle), s = this.option.island, l = {
                zlevel: s.zlevel,
                z: s.z,
                style: {
                    x: e.style.x,
    ...
    var i = e("./base"), n = e("zrender/shape/Line"), a = e("zrender/shape/Image"), o = e("zrender/shape/Rectangle"), r = e("../util/shape/Icon"), s = e("../config");
    s.toolbox = {
        zlevel: 0,
        z: 6,
        show: !1,
    ...
    var l = e("zrender/tool/util"), h = e("zrender/config"), d = e("zrender/tool/event"), c = "stack", m = "tiled";
    return t.prototype = {
    ...
    return t.prototype = {
        type: o.COMPONENT_TYPE_TITLE, _buildShape: function () {
            ...
            var e = this.titleOption.text, t = this.titleOption.link, i = this.titleOption.target, a = this.titleOption.subtext, o = this.titleOption.sublink, r = this.titleOption.subtarget, s = this.getFont(this.titleOption.textStyle), h = this.getFont(this.titleOption.subtextStyle), d = this._itemGroupLocation.x, c = this._itemGroupLocation.y, m = this._itemGroupLocation.width, p = this._itemGroupLocation.height, u = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {y: c, color: this.titleOption.textStyle.color, text: e, textFont: s, textBaseline: "top"},
    ...
    var i = e("./base"), n = e("../util/shape/Cross"), a = e("zrender/shape/Line"), o = e("zrender/shape/Rectangle"), r = new o({}), s = e("../config");
    s.tooltip = {
        zlevel: 1,
        z: 8,
        show: !0,
    ...
    var l = e("../util/ecData"), h = e("zrender/config"), d = e("zrender/tool/event"), c = e("zrender/tool/area"), m = e("zrender/tool/color"), p = e("zrender/tool/util"), u = e("zrender/shape/Base");
    return t.prototype = {
        ...
        _showItemTrigger: function (e) {
            if (this._curTarget) {
                ...
                var f = d.getX(this._event), y = d.getY(this._event);
        ...
        _styleAxisPointer: function (e, t, i, n, a, o, r, s) {
            if (e.length > 0) {
                var l, h, d = this.option.tooltip.axisPointer, c = d.type, m = {line: {}, cross: {}, shadow: {}};
                    ...
                    if (d)if (c) {
                        ...
                        switch (d.type) {
                            ...
                            case s.CHART_TYPE_RADAR:
                                ...
                                var p = r.polarIndex || 0, u = this.component.polar.getVector(p, m, "max");
                                this._event = {zrenderX: u[0], zrenderY: u[1]}, this._showPolarTrigger(p, m)
                        }
                    } else {
                        ...
                        switch (d.type) {
                            ...
                            case s.CHART_TYPE_PIE:
                                for (var f = e.name, a = 0, o = g.length; o > a; a++)if ("sector" === g[a].type && l.get(g[a], "seriesIndex") == t && l.get(g[a], "name") == f) {
                                    this._curTarget = g[a];
                                    var y = this._curTarget.style, b = (y.startAngle + y.endAngle) / 2 * Math.PI / 180;
    ...
    var i = e("./base"), n = e("zrender/shape/Text"), a = e("zrender/shape/Rectangle"), o = e("zrender/shape/Sector"), r = e("../util/shape/Icon"), s = e("../util/shape/Candle"), l = e("../config");
    l.legend = {
        zlevel: 0,
        z: 4,
        show: !0,
    ...
    t.prototype = {
        type: l.COMPONENT_TYPE_LEGEND, _buildShape: function () {
            ...
            var e = this.legendOption.data, t = e.length, i = this.legendOption.itemGap, n = this.legendOption.itemWidth + 5, a = this.legendOption.itemHeight, o = this.legendOption.textStyle, r = this.getFont(o), s = 0, l = 0, c = this.reformCssArray(this.legendOption.padding), m = this.zr.getWidth() - c[1] - c[3], p = this.zr.getHeight() - c[0] - c[2], u = 0, V = 0;
            ...
            return {x: f, y: y, width: s, height: l, maxWidth: V}
    ...
    var c = {
        line: function (e, t) {
            ...
            o.prototype.buildPath(e, {x: i + a / 2, y: n + r + 2, r: r, r0: 6, startAngle: 45, endAngle: 135})
    ...
    function z(e) {
        ...
        if (0 === o)t = 255 * r, i = 255 * r, n = 255 * r; else {
            var s = 6 * a;
            6 === s && (s = 0);
            var l = 0 | s, h = r * (1 - o), d = r * (1 - o * (s - l)), c = r * (1 - o * (1 - (s - l))), m = 0, p = 0, u = 0;
    ...
    function F(e) {
        ...
        if (0 === l)t = 0, i = 0; else {
            i = l / s;
            var d = ((s - n) / 6 + l / 2) / l, c = ((s - a) / 6 + l / 2) / l, m = ((s - o) / 6 + l / 2) / l;
    ...
    var n = e("./base"), a = e("zrender/shape/Rectangle"), o = e("../util/shape/Icon"), r = e("../util/shape/Chain"), s = e("../config");
    s.timeline = {
        zlevel: 0,
        z: 4,
        show: !0,
    ...
    return t.prototype = {
        type: s.COMPONENT_TYPE_TIMELINE, _buildShape: function () {
                    ...
                    for (i = 0; !l && o > i;) {
                        ...
                        for (var d = i; o > d; d += i) {
                            if (r = e[d].x - e[d - i].x, 0 !== t.label.rotate)s = n; else if (a[d].textStyle)s = h.getTextWidth(e[d].name, e[d].textFont); else {
                                var c = e[d].name + "", m = (c.match(/\w/g) || "").length, p = c.length - m;
                                s = m * n * 2 / 3 + p * n
                            }
                            if (s > r) {
                                l = !1;
            ...
            if (p > 1) {
                var V = m / p;
                if (V = V > 50 ? 50 : 20 > V ? 5 : V, m -= 2 * V, "number" === i.type)for (var U = 0; p > U; U++)u.push(d + V + m / (p - 1) * U); else {
        ...
        type: "image", brush: function (e, t, i) {
            ...
            if (a) {
                ...
                if (e.save(), this.doClip(e), this.setContext(e, n), this.setTransform(e), n.sWidth && n.sHeight) {
                    var c = n.sx || 0, m = n.sy || 0;
                    e.drawImage(a, c, m, n.sWidth, n.sHeight, h, d, s, l)
                } else if (n.sx && n.sy) {
                    var c = n.sx, m = n.sy, p = s - c, u = l - m;
    ...
    return n.inherits(t, i), t.prototype._start = function (e, t) {
        for (var i = n.merge(this.options, {
            ...
            var V = -Math.ceil(1e3 * Math.random()), U = Math.ceil(400 * Math.random()), g = Math.ceil(Math.random() * p), f = "random" == l.color ? a.random() : l.color;
            c[u] = new o({
                highlightStyle: {xStart: V, yStart: g, xEnd: V + U, yEnd: g, strokeColor: f, lineWidth: d},
    ...
    return n.inherits(t, i), t.prototype._start = function (e, t) {
        ...
        for (var h = this.createTextShape(i.textStyle), d = this.createBackgroundShape(i.backgroundColor), c = s.x, m = s.y, p = s.r0 + 6, u = s.r - 6, V = s.color, U = a.lift(V, .1), g = new o({highlightStyle: n.clone(s)}), f = [], y = a.getGradientColors(["#ff6400", "#ffe100", "#97ff00"], 25), b = 15, _ = 240, x = 0; 16 > x; x++)f.push(new r({
            highlightStyle: {
                x: c,
                y: m,
                r0: p,
    ...
    return n.inherits(t, i), t.prototype._start = function (e, t) {
        var i = n.merge(this.options, {
            ...
            backgroundColor: "rgba(0, 0, 0, 0.8)"
        }), s = this.createTextShape(i.textStyle), l = 10, h = o.getTextWidth(s.highlightStyle.text, s.highlightStyle.textFont), d = o.getTextHeight(s.highlightStyle.text, s.highlightStyle.textFont), c = n.merge(this.options.effect || {}, {
            r0: 9,
            r: 15,
            n: 18,
            color: "#fff",
    ...
    return n.inherits(t, i), t.prototype._start = function (e, t) {
        var i = n.merge(this.options, {
            ...
            backgroundColor: "rgba(250, 250, 250, 0.8)"
        }), l = this.createTextShape(i.textStyle), h = 10, d = a.getTextWidth(l.highlightStyle.text, l.highlightStyle.textFont), c = a.getTextHeight(l.highlightStyle.text, l.highlightStyle.textFont), m = n.merge(this.options.effect || {}, {
            r: 18,
            colorIn: "#fff",
            colorOut: "#555",
            colorWhirl: "#6cf",
    ...
    var e = {
        ...
        gauge: {
            ...
            startAngle: 180,
            endAngle: 0,
            axisLine: {show: !0, lineStyle: {color: [[.2, "#B5C334"], [.8, "#27727B"], [1, "#C1232B"]], width: "40%"}},
    ...
    return document.createElement("canvas").getContext ? G_vmlCanvasManager = !1 : !function () {
        ...
        function p(e) {
            var t, i, n, a, o, r;
            if (a = parseFloat(e[0]) / 360 % 360, 0 > a && a++, o = m(c(e[1]), 0, 1), r = m(c(e[2]), 0, 1), 0 == o)t = i = n = r; else {
        ...
        function k(e, t, i, n) {
            ...
            if (a instanceof W) {
                var h = 0, d = {x: 0, y: 0}, c = 0, m = 1;
                if ("gradient" == a.type_) {
                    var p = a.x0_ / o, u = a.y0_ / r, U = a.x1_ / o, g = a.y1_ / r, f = v(e, p, u), y = v(e, U, g), b = y.x - f.x, _ = y.y - f.y;
                    h = 180 * Math.atan2(b, _) / Math.PI, 0 > h && (h += 360), 1e-6 > h && (h = 0)
                } else {
                    var f = v(e, a.x0_, a.y0_);
                    d = {x: (f.x - i.x) / s, y: (f.y - i.y) / l}, s /= o * F, l /= r * F;
                    var x = C.max(s, l);
                ...
                var J = V(e.fillStyle), O = J.color, P = J.alpha * e.globalAlpha;
        ...
        function v(e, t, i) {
            var n = e.m_;
            return {x: F * (t * n[0][0] + i * n[1][0] + n[2][0]) - J, y: F * (t * n[0][1] + i * n[1][1] + n[2][1]) - J}
        }
        ...
        var C = Math, T = C.round, E = C.sin, z = C.cos, A = C.abs, M = C.sqrt, F = 10, J = F / 2, O = (+navigator.userAgent.match(/MSIE ([\d.]+)?/)[1], Array.prototype.slice);
        a(document);
        var P = {
            init: function (e) {
                var i = e || document;
        ...
        var H = {
            ...
            size: 12,
            family: "微软雅黑"
        }, Y = {}, Z = {butt: "flat", round: "round"}, Q = b.prototype;
        Q.clearRect = function () {
            ...
            var r = v(this, a, o), s = v(this, e, t), l = v(this, i, n);
            _(this, s, l, r)
        }, Q.quadraticCurveTo = function (e, t, i, n) {
            var a = v(this, e, t), o = v(this, i, n), r = {
            ...
            i *= F;
            var r = o ? "at" : "wa", s = e + z(n) * i - J, l = t + E(n) * i - J, h = e + z(a) * i - J, d = t + E(a) * i - J;
            s != h || o || (s += .125);
            var c = v(this, e, t), m = v(this, s, l), p = v(this, h, d);
            this.currentPath_.push({type: r, x: c.x, y: c.y, radius: i, xStart: m.x, yStart: m.y, xEnd: p.x, yEnd: p.y})
            ...
            var c = e.width, m = e.height;
            if (e.runtimeStyle.width = h, e.runtimeStyle.height = d, 3 == arguments.length)t = arguments[1], i = arguments[2], o = r = 0, s = n = c, l = a = m; else if (5 == arguments.length)t = arguments[1], i = arguments[2], n = arguments[3], a = arguments[4], o = r = 0, s = c, l = m; else {
            ...
            var p = v(this, t, i), u = [], V = 10, U = 10, g = y = 1;
            ...
            var t = z(e), i = E(e), n = [[t, i, 0], [-i, t, 0], [0, 0, 1]];
            ...
            var r = this.m_, s = 1e3, l = 0, h = s, d = {
                x: 0,
                y: 0
            }, c = [], m = g(U(this.font), this.element_), p = f(m), u = this.element_.currentStyle, V = this.textAlign.toLowerCase();
            ...
            var b = r[0][0].toFixed(3) + "," + r[1][0].toFixed(3) + "," + r[0][1].toFixed(3) + "," + r[1][1].toFixed(3) + ",0,0", _ = T(y.x / F) + "," + T(y.y / F);
    ...
    var o = e("./config"), r = e("./tool/env"), s = e("./tool/event"), l = e("./tool/util"), h = e("./tool/vector"), d = e("./tool/matrix"), c = o.EVENT, m = e("./mixin/Eventful"), p = ["resize", "click", "dblclick", "mousewheel", "mousemove", "mouseout", "mouseup", "mousedown", "touchstart", "touchend", "touchmove"], u = function (e) {
        ...
        resize: function (e) {
            ...
            if (u(e) || t) {
                e = this._zrenderEventFixed(e);
                var i = e.wheelDelta || -e.detail, n = i > 0 ? 1.1 : 1 / 1.1, a = !1, o = this._mouseX, r = this._mouseY;
            ...
            if ((u(e) || t) && !this.painter.isLoading()) {
                ...
                var i = this._mouseX - this._lastX, n = this._mouseY - this._lastY;
                ...
                var a = "default";
                if (this._draggingTarget)this.storage.drift(this._draggingTarget.id, i, n), this._draggingTarget.modSelf(), this.storage.addHover(this._draggingTarget), this._clickThreshold++; else if (this._isMouseDown) {
                    var o = !1;
    ...
    U.prototype.on = function (e, t, i) {
        ...
        if (e)o.cancelBubble || this.dispatch(t, o); else if (!n) {
            var s = {type: t, event: i};
    ...
    var g = [{x: 10}, {x: -20}, {x: 10, y: 10}, {y: -20}];
    ...
    var a = e("./config"), o = e("./tool/util"), r = e("./tool/log"), s = e("./loadingEffect/Base"), l = e("./Layer"), h = function (e, i) {
    ...
    return h.prototype.render = function (e) {
        ...
        for (var n = 0; n < this._zlevelList.length; n++) {
            var a = this._zlevelList[n], o = this._layers[a];
        ...
        var i = this._zlevelList.length, a = null, o = -1;
        ...
        for (var i = 0; i < this._zlevelList.length; i++) {
            var n = this._zlevelList[i], a = this._layers[n];
    ...
    function r(e, t, i, n, a, o, r, l, h) {
        var d = e.length;
        if (1 == h)for (var c = 0; d > c; c++)l[c] = s(e[c], t[c], i[c], n[c], a, o, r); else for (var m = e[0].length, c = 0; d > c; c++)for (var p = 0; m > p; p++)l[c][p] = s(e[c][p], t[c][p], i[c][p], n[c][p], a, o, r)
    }
    ...
    var d = e("./Clip"), c = e("../tool/color"), m = e("../tool/util"), p = e("../tool/event").Dispatcher, u = window.requestAnimationFrame || window.msRequestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || function (e) {
            setTimeout(e, 16)
    ...
    return g.prototype = {
        when: function (e, t) {
            ...
            var t = this, i = this._setter, l = this._getter, m = "spline" === e, p = function () {
                ...
                var U = u.length;
                if (U) {
                    var g = u[0].value, f = o(g), y = !1, b = f && o(g[0]) ? 2 : 1;
                    u.sort(function (e, t) {
                    ...
                    if (U) {
                        ...
                        var z = function (e, o) {
                            ...
                            var d = x[v + 1] - x[v];
                            if (0 !== d) {
                                if (W = (o - x[v]) / d, m)if (I = k[v], X = k[0 === v ? v : v - 1], S = k[v > U - 2 ? U - 1 : v + 1], K = k[v > U - 3 ? U - 1 : v + 2], f)r(X, I, S, K, W, W * W, W * W * W, l(e, V), b); else {
                                    var c;
                                    y ? (c = r(X, I, S, K, W, W * W, W * W * W, E, 1), c = h(E)) : c = s(X, I, S, K, W, W * W, W * W * W), i(e, V, c)
                                } else if (f)a(k[v], k[v + 1], W, l(e, V), b); else {
                                    var c;
    ...
    function i(e, t, i) {
        var n = document.createElement(t), a = i.getWidth(), o = i.getHeight();
    ...
    var n = e("./mixin/Transformable"), a = e("./tool/util"), o = window.G_vmlCanvasManager, r = e("./config"), s = function (e, a) {
    ...
    return s.prototype.initContext = function () {
        ...
        var e = this.dom, t = this.ctx, i = e.width, n = e.height, a = this.clearColor && !o, s = this.motionBlur && !o, l = this.lastFrameAlpha, h = r.devicePixelRatio;
    ...
    function f(e, t, i, n, a, o, r, s, l, h) {
        ...
        for (var c, m, p = 0, u = -1, V = 0; d > V; V++) {
            var U = T[V], f = w.cubicAt(e, i, a, r, U);
        ...
        for (var g = "stroke" === i || "both" === i, _ = "fill" === i || "both" === i, x = 0; x < e.length; x++) {
            ...
            switch (k.command) {
                ...
                case"Q":
                    ...
                    break;
                case"A":
                    var L = v[0], w = v[1], W = v[2], X = v[3], I = v[4], S = v[5], K = Math.cos(I) * W + L, C = Math.sin(I) * X + w;
    ...
    return d.prototype.doClip = function (e) {
        ...
        if ("undefined" != typeof i.text && i.text !== !1) {
            ...
            switch (d) {
                ...
                case"start":
                case"end":
                    var m = i.pointList || [[i.xStart || 0, i.yStart || 0], [i.xEnd || 0, i.yEnd || 0]], p = m.length;
                    if (2 > p)return;
                    var u, V, U, g;
                    switch (d) {
                        case"start":
    ...
    function o(e, i, n, a, o, r) {
        var s = a + 3 * (i - n) - e, l = 3 * (n - 2 * i + e), h = 3 * (i - e), d = e - o, c = l * l - 3 * s * h, m = l * h - 9 * s * d, p = h * h - 3 * l * d, u = 0;
        if (t(c) && t(m))if (t(l))r[0] = 0; else {
            var V = -h / l;
            V >= 0 && 1 >= V && (r[u++] = V)
        } else {
            var U = m * m - 4 * c * p;
            if (t(U)) {
                var y = m / c, V = -l / s + y, b = -y / 2;
                V >= 0 && 1 >= V && (r[u++] = V), b >= 0 && 1 >= b && (r[u++] = b)
            } else if (U > 0) {
                var _ = Math.sqrt(U), x = c * l + 1.5 * s * (-m + _), k = c * l + 1.5 * s * (-m - _);
                x = 0 > x ? -Math.pow(-x, f) : Math.pow(x, f), k = 0 > k ? -Math.pow(-k, f) : Math.pow(k, f);
                var V = (-l - (x + k)) / (3 * s);
                V >= 0 && 1 >= V && (r[u++] = V)
            } else {
                var v = (2 * c * l - 3 * s * m) / (2 * Math.sqrt(c * c * c)), L = Math.acos(v) / 3, w = Math.sqrt(c), W = Math.cos(L), V = (-l - 2 * w * W) / (3 * s), b = (-l + w * (W + g * Math.sin(L))) / (3 * s), X = (-l + w * (W - g * Math.sin(L))) / (3 * s);
    ...
    function r(e, n, a, o, r) {
        ...
        if (t(l)) {
            ...
            var m = s * s - 4 * l * h;
            if (t(m))r[0] = -s / (2 * l); else if (m > 0) {
                var p = Math.sqrt(m), c = (-s + p) / (2 * l), u = (-s - p) / (2 * l);
    ...
    function s(e, t, i, n, a, o) {
        var r = (t - e) * a + e, s = (i - t) * a + t, l = (n - i) * a + i, h = (s - r) * a + r, d = (l - s) * a + s, c = (d - h) * a + h;
    ...
    function c(e, n, a, o, r) {
        ...
        if (t(s)) {
            ...
            if (t(m)) {
                ...
                var p = Math.sqrt(m), c = (-l + p) / (2 * s), u = (-l - p) / (2 * s);
                c >= 0 && 1 >= c && (r[d++] = c), u >= 0 && 1 >= u && (r[d++] = u)
            }
        }
        return d
    ...
    function p(e, t, i, n, a) {
        var o = (t - e) * n + e, r = (i - t) * n + t, s = (r - o) * n + o;
    ...
    var V = e("./vector"), U = 1e-4, g = Math.sqrt(3), f = 1 / 3, y = V.create(), b = V.create(), _ = V.create();
    return {
        cubicAt: n,
        cubicDerivativeAt: a,
        cubicRootAt: o,
    ...
    var n = e("../tool/matrix"), a = e("../tool/vector"), o = [0, 0], r = n.translate, s = 5e-5, l = function () {
    ...
    function i(e, t, i, n, a) {
        ...
        this.selectedMap = {}, this.lastShapeList = [], this.shapeHandler = {
            onclick: function () {
                ...
                var i = t.highlightStyle, n = i.brushTyep, a = i.strokeColor, r = i.lineWidth;
    ...
    var n = e("zrender/shape/Image"), a = e("../util/shape/Icon"), o = e("../util/shape/MarkLine"), r = e("../util/shape/Symbol"), s = e("zrender/shape/Polyline"), l = e("zrender/shape/ShapeBundle"), h = e("../config"), d = e("../util/ecData"), c = e("../util/ecAnimation"), m = e("../util/ecEffect"), p = e("../util/accMath"), u = e("../component/base"), V = e("../layout/EdgeBundling"), U = e("zrender/tool/util"), g = e("zrender/tool/area");
    return i.prototype = {
        setCalculable: function (e) {
            ...
            if (this.isDragend && e.target && !t.dragOut) {
                var i = e.target, n = d.get(i, "seriesIndex"), a = d.get(i, "dataIndex"), o = this.series;
                if (null != o[n].data[a].value) {
                    o[n].data[a].value = "-";
                    var r = o[n].data[a].name, s = this.component.legend;
            ...
            for (var t, i, n, a, o = this.series, r = 0, s = {}, l = "__kener__stack__", d = this.component.legend, c = [], m = 0, p = 0, u = e.length; u > p; p++) {
                if (t = o[e[p]], n = t.name, this._sIndex2ShapeMap[e[p]] = this._sIndex2ShapeMap[e[p]] || this.query(t, "symbol") || this._symbol[p % this._symbol.length], d) {
                    if (this.selectedMap[n] = d.isSelected(n), this._sIndex2ColorMap[e[p]] = d.getColor(n), a = d.getItemShape(n)) {
                        var V = a.style;
                        if (this.type == h.CHART_TYPE_LINE)V.iconType = "legendLineIcon", V.symbol = this._sIndex2ShapeMap[e[p]]; else if (t.itemStyle.normal.barBorderWidth > 0) {
            ...
            return {locationMap: c, maxDataLength: m}
        }, _calculMarkMapXY: function (e, t, i) {
            for (var n = this.series, a = 0, o = t.length; o > a; a++)for (var r = 0, s = t[a].length; s > r; r++) {
                var l = t[a][r], h = "xy" == i ? 0 : "", d = this.component.grid, c = e[l];
                if ("-1" != i.indexOf("x")) {
                    c["counter" + h] > 0 && (c["average" + h] = c["sum" + h] / c["counter" + h]);
                    var m = this.component.xAxis.getAxis(n[l].xAxisIndex || 0).getCoord(c["average" + h]);
                    c["averageLine" + h] = [[m, d.getYend()], [m, d.getY()]], c["minLine" + h] = [[c["minX" + h], d.getYend()], [c["minX" + h], d.getY()]], c["maxLine" + h] = [[c["maxX" + h], d.getYend()], [c["maxX" + h], d.getY()]], c.isHorizontal = !1
                }
                if (h = "xy" == i ? 1 : "", "-1" != i.indexOf("y")) {
                    c["counter" + h] > 0 && (c["average" + h] = c["sum" + h] / c["counter" + h]);
                    var p = this.component.yAxis.getAxis(n[l].yAxisIndex || 0).getCoord(c["average" + h]);
                    c["averageLine" + h] = [[d.getX(), p], [d.getXend(), p]], c["minLine" + h] = [[d.getX(), c["minY" + h]], [d.getXend(), c["minY" + h]]], c["maxLine" + h] = [[d.getX(), c["maxY" + h]], [d.getXend(), c["maxY" + h]]], c.isHorizontal = !0
                }
            }
            ...
            var d = this._markLine(e, a), c = a.large;
            if (c) {
                var m = new l({style: {shapeList: d}}), p = d[0];
                if (p) {
            ...
            return function (i, n) {
                var a = this.series[i], o = this.component, r = o.dataRange, s = o.legend;
                ...
                for (var c = n.data, m = [], p = this.zr.getWidth(), u = this.zr.getHeight(), g = 0; g < c.length; g++) {
                    var f = c[g];
                    if (t(f[0]) && t(f[1])) {
                        var y = this.deepMerge(f), b = [y, n], _ = l, x = null != y.value ? y.value : "";
                        if (r) {
                            _ = isNaN(x) ? _ : r.getColor(x);
                            var k = this.deepQuery(b, "itemStyle.normal.color") || _, v = this.deepQuery(b, "itemStyle.emphasis.color") || k;
                            if (null == k && null == v)continue
                        }
                        f[0].tooltip = y.tooltip || n.tooltip || {trigger: "item"}, f[0].name = f[0].name || "", f[1].name = f[1].name || "", f[0].value = x, m.push({
                ...
                for (var W = [], g = 0, X = m.length; X > g; g++) {
                    var I = m[g], S = I.rawEdge || I, f = S.rawData, x = null != f.value ? f.value : "", K = this.getMarkLineShape(n, i, f, g, I.points, L, S.color);
                    K._mark = "line";
            ...
            var u = [i, e], V = this.getDataFromOption(i, "-");
            h = this.deepQuery(u, "symbol") || h;
            var U = this.deepQuery(u, "symbolSize");
            U = "function" == typeof U ? U(V) : U, "number" == typeof U && (U = [U, U]);
            var g = this.deepQuery(u, "symbolRotate"), f = this.deepMerge(u, "itemStyle.normal"), y = this.deepMerge(u, "itemStyle.emphasis"), b = null != f.borderWidth ? f.borderWidth : f.lineStyle && f.lineStyle.width;
            null == b && (b = h.match("empty") ? 2 : 0);
            var _ = null != y.borderWidth ? y.borderWidth : y.lineStyle && y.lineStyle.width;
            null == _ && (_ = b + 2);
            var x = this.getItemStyleColor(f.color, t, o, i), k = this.getItemStyleColor(y.color, t, o, i), v = U[0], L = U[1], w = new a({
                style: {
            ...
            var h = null != i[0].value ? i[0].value : "-", d = null != i[1].value ? i[1].value : "-", c = [i[0].symbol || e.symbol[0], i[1].symbol || e.symbol[1]], m = [i[0].symbolSize || e.symbolSize[0], i[1].symbolSize || e.symbolSize[1]];
            m[0] = "function" == typeof m[0] ? m[0](h) : m[0], m[1] = "function" == typeof m[1] ? m[1](d) : m[1];
            var p = [this.query(i[0], "symbolRotate") || e.symbolRotate[0], this.query(i[1], "symbolRotate") || e.symbolRotate[1]], u = [i[0], i[1], e], V = this.deepMerge(u, "itemStyle.normal");
            ...
            var g = V.lineStyle, f = U.lineStyle, y = g.width;
            ...
            if (this.selectedMap[n.name]) {
                var a = this.query(this.option, "animationDurationUpdate"), o = this.query(this.option, "animationEasing"), r = n[i].data, s = this.shapeList.length;
    ...
    var I = e("zrender/tool/util"), S = e("zrender/shape/Base");
    return X.prototype = {
        type: "icon",
        iconLibrary: {
            mark: t,
    ...
    var i = e("zrender/shape/Base"), n = e("./Icon"), a = e("zrender/shape/Line"), o = new a({}), r = e("zrender/shape/BezierCurve"), s = new r({}), l = e("zrender/tool/area"), h = e("zrender/shape/util/dashedLineTo"), d = e("zrender/tool/util"), c = e("zrender/tool/curve");
    return t.prototype = {
        type: "mark-line", brush: function (e, t) {
            ...
            } else if ("solid" == i)e.lineTo(t.xEnd, t.yEnd); else {
                var a = (t.lineWidth || 1) * ("dashed" == t.lineType ? 5 : 1);
                h(e, t.xStart, t.yStart, t.xEnd, t.yEnd, a)
            }
        }, updatePoints: function (e) {
            var t = e.curveness || 0, i = 1, n = e.xStart, a = e.yStart, o = e.xEnd, r = e.yEnd, s = (n + o) / 2 - i * (a - r) * t, l = (a + r) / 2 - i * (o - n) * t;
            e.cpX1 = s, e.cpY1 = l
            ...
            if ("none" != t.symbol[i]) {
                ...
                var o = t.xStart, r = t.yStart, s = t.xEnd, l = t.yEnd, h = 0 === i ? o : s, d = 0 === i ? r : l, m = t.curveness || 0, p = null != t.symbolRotate[i] ? t.symbolRotate[i] - 0 : 0;
                if (p = p / 180 * Math.PI, "arrow" == a && 0 === p)if (0 === m) {
                    var u = 0 === i ? -1 : 1;
                    p = Math.PI / 2 + Math.atan2(u * (l - r), u * (s - o))
                } else {
                    var V = t.cpX1, U = t.cpY1, g = c.quadraticDerivativeAt, f = g(o, V, s, i), y = g(r, U, l, i);
    ...
    return t.prototype = {
        type: "symbol", buildPath: function (e, t) {
            ...
            if (0 !== n)for (var a, o, r, s, l, h = 1e4, d = Math.ceil(n / h), c = i[0] instanceof Array, m = t.size ? t.size : 2, p = m, u = m / 2, V = 2 * Math.PI, U = 0; d > U; U++) {
                ...
                for (var g = a; o > g; g++)if (t.random && (r = t["randomMap" + g % 20] / 100, p = m * r * r, u = p / 2), c ? (s = i[g][0], l = i[g][1]) : (s = i[g].x, l = i[g].y), 3 > p)e.rect(s - u, l - u, p, p); else switch (t.iconType) {
                    case"circle":
    ...
    return i.prototype = {
        constructor: i, type: "shape-bundle", brush: function (e, t) {
            var i = this.beforeBrush(e, t);
            e.beginPath();
            for (var n = 0; n < i.shapeList.length; n++) {
                var a = i.shapeList[n], o = a.style;
            ...
            if (e.__rect)return e.__rect;
            for (var t = 1 / 0, i = -(1 / 0), n = 1 / 0, a = -(1 / 0), o = 0; o < e.shapeList.length; o++)var r = e.shapeList[o], s = r.getRect(r.style), t = Math.min(s.x, t), n = Math.min(s.y, n), i = Math.max(s.x + s.width, i), a = Math.max(s.y + s.height, a);
            return e.__rect = {x: t, y: n, width: i - t, height: a - n}, e.__rect
        }, isCover: function (e, t) {
            var i = this.transformCoordToLocal(e, t);
    ...
    function t(e, t, i, n, a) {
        ...
        o = t.style.pointList;
        var c = o.length;
        i.style.pointList = c == s ? o : s > c ? o.concat(r.slice(c)) : o.slice(0, s), e.addShape(i), i.__animating = !0, e.animate(i.id, "style").when(n, {pointList: r}).during(function () {
    ...
    function n(e, t, n, a, o) {
        ...
        var s = r.x, l = r.y, h = r.width, d = r.height, c = [n.position[0], n.position[1]];
        i(n, t, "x", "y", "width", "height"), n.position = t.position, e.addShape(n), (c[0] != t.position[0] || c[1] != t.position[1]) && e.animate(n.id, "").when(a, {position: c}).start(o), n.__animating = !0, e.animate(n.id, "style").when(a, {
            x: s,
            y: l,
            width: h,
            height: d
    ...
    function a(e, t, i, n, a) {
        ...
        var r = i.style.y;
        i.style.y = t.style.y, e.addShape(i), i.__animating = !0, e.animate(i.id, "style").when(n, {y: r}).done(function () {
            i.__animating = !1
        }).start(a)
    }
    ...
    function o(e, t, i, n, a) {
        ...
        i.__animating = !0, "r" != i._animationAdd ? (i.style.r0 = 0, i.style.r = 0, i.rotation = [2 * Math.PI, o, r], e.addShape(i), e.animate(i.id, "style").when(n, {
            ...
            i.__animating = !1
        }).start(a), e.animate(i.id, "").when(n, {rotation: [0, o, r]}).start(a)) : (i.style.r0 = i.style.r, e.addShape(i), e.animate(i.id, "style").when(n, {r0: s}).done(function () {
            i.__animating = !1
        }).start(a))
    }
    ...
    function l(t, i, n, a, o) {
        ...
        n.scale = [.1, .1, s, l], t.addShape(n), n.__animating = !0, t.animate(n.id, "").when(a, {scale: [1, 1, s, l]}).done(function () {
            n.__animating = !1
        }).start(o)
    }
    ...
    function d(e, t, i, n, a) {
        ...
        var o = i.style.angle;
        i.style.angle = t.style.angle, e.addShape(i), i.__animating = !0, e.animate(i.id, "style").when(n, {angle: o}).done(function () {
            i.__animating = !1
        }).start(a)
    }
    ...
    function c(e, t, i, a, o, r) {
        if (i.style._x = i.style.x, i.style._y = i.style.y, i.style._width = i.style.width, i.style._height = i.style.height, t)n(e, t, i, a, o); else {
            ...
            i.scale = [.01, .01, s, l], e.addShape(i), i.__animating = !0, e.animate(i.id, "").delay(r).when(a, {scale: [1, 1, s, l]}).done(function () {
                i.__animating = !1
            }).start(o || "QuinticOut")
        }
    }
    ...
    function p(e, t, i, n, a) {
        ...
        var o = i.style, r = function () {
            i.__animating = !1
        }, s = o.xStart, l = o.yStart, h = o.xEnd, d = o.yEnd;
        if (o.curveness > 0) {
            i.updatePoints(o);
            var c = {p: 0}, m = o.cpX1, p = o.cpY1, u = [], U = [], g = V.quadraticSubdivide;
            e.animation.animate(c).when(n, {p: 1}).during(function () {
                g(s, m, h, c.p, u), g(l, p, d, c.p, U), o.cpX1 = u[1], o.cpY1 = U[1], o.xEnd = u[2], o.yEnd = U[2], e.modShape(i)
            }).done(r).start(a)
        } else e.animate(i.id, "style").when(0, {xEnd: s, yEnd: l}).when(n, {xEnd: h, yEnd: d}).done(r).start(a)
    }
    ...
    function t(e, t, i, n) {
        ...
        var V = "image" !== i.type ? window.devicePixelRatio || 1 : 1, U = (a.style.width / V - i.style._width) / 2;
        ...
        var f = a.style.x + a.style.width / 2 / V, y = a.style.y + a.style.height / 2 / V;
        "scale" === r.type ? (e.modShape(a.id, {scale: [.1, .1, f, y]}), e.animate(a.id, "", r.loop).when(g, {scale: [1, 1, f, y]}).done(function () {
            i.effect.show = !1, e.delShape(a.id)
        }).start()) : e.animate(a.id, "style", r.loop).when(g, {y: a.style.y - m}).when(2 * g, {y: a.style.y}).done(function () {
            i.effect.show = !1, e.delShape(a.id)
        }).start()
    }

    function i(e, t, i, n) {
        var a = i.effect, o = a.color || i.style.strokeColor || i.style.color, r = a.scaleSize, s = a.shadowColor || o, l = "undefined" != typeof a.shadowBlur ? a.shadowBlur : 2 * r, h = window.devicePixelRatio || 1, c = new d({
            zlevel: n,
            position: i.position,
            scale: i.scale,
            style: {
        ...
        t.push(c), e.addShape(c), e.modShape(i.id, {invisible: !0});
    ...
    function n(e, t, i, n, a) {
        var s = i.effect, h = i.style, d = s.color || h.strokeColor || h.color, c = s.shadowColor || h.strokeColor || d, V = h.lineWidth * s.scaleSize, U = "undefined" != typeof s.shadowBlur ? s.shadowBlur : V, g = new r({
            zlevel: n,
        ...
        if (i instanceof m) {
            for (var b = [0], _ = 0, x = h.pointList, k = h.controlPointList, v = 1; v < x.length; v++) {
                if (k) {
                    var L = k[2 * (v - 1)], w = k[2 * (v - 1) + 1];
                    _ += p.dist(x[v - 1], L) + p.dist(L, w) + p.dist(w, x[v])
                } else _ += p.dist(x[v - 1], x[v]);
                b.push(_)
            }
            for (var W = {p: 0}, X = e.animation.animate(W, {loop: s.loop}), v = 0; v < b.length; v++)X.when(b[v] * s.period, {p: v});
            X.during(function () {
                var t, i, n = Math.floor(W.p);
                if (n == x.length - 1)t = x[n][0], i = x[n][1]; else {
                    var o = W.p - n, r = x[n], s = x[n + 1];
                    if (k) {
                        var h = k[2 * n], d = k[2 * n + 1];
            ...
            var I = h.xStart - f, S = h.yStart - f, K = h.xEnd - f, C = h.yEnd - f;
            g.style.x = I, g.style.y = S;
            var T = (K - I) * (K - I) + (C - S) * (C - S), E = Math.round(Math.sqrt(Math.round(T * s.period * s.period)));
            if (i.style.curveness > 0) {
                var z = h.cpX1 - f, A = h.cpY1 - f;
                g.effectAnimator = e.animation.animate(g, {loop: s.loop}).when(E, {p: 1}).during(function (t, i) {
                    g.style.x = l.quadraticAt(I, z, K, i), g.style.y = l.quadraticAt(S, A, C, i), a || e.modShape(g)
                }).done(y).start()
            } else g.effectAnimator = e.animation.animate(g.style, {loop: s.loop}).when(E, {
                x: K,
                y: C
            }).during(function () {
                a || e.modShape(g)
    ...
    function a(e, t, i, a) {
        var o = new c({style: {shapeList: []}, zlevel: a, hoverable: !1}), r = i.style.shapeList, s = i.effect;
        o.position = i.position;
        for (var l = 0, h = [], d = 0; d < r.length; d++) {
            r[d].effect = s;
            var m = n(e, null, r[d], a, !0), p = m.effectAnimator;
    ...
    var o = e("../util/ecData"), r = e("zrender/shape/Circle"), s = e("zrender/shape/Image"), l = e("zrender/tool/curve"), h = e("../util/shape/Icon"), d = e("../util/shape/Symbol"), c = e("zrender/shape/ShapeBundle"), m = e("zrender/shape/Polyline"), p = e("zrender/tool/vector"), u = e("zrender/tool/env").canvasSupported;
    return {point: t, largePoint: i, line: n, largeLine: a}
    ...
    function t(e, t) {
        e = e.array, t = t.array;
        var i = t[0] - e[0], n = t[1] - e[1], a = t[2] - e[2], o = t[3] - e[3];
    ...
    var r = e("../data/KDTree"), s = e("zrender/tool/vector"), l = s.create, h = s.distSquare, d = s.dist, c = s.copy, m = s.clone;
    return n.prototype.getStartPoint = function () {
        ...
        constructor: o, run: function (e) {
            ...
            return {groups: o, edges: i, savedInk: s}
            ...
            return function (a, o, r, l) {
                var c = Math.cos(this.maxTurningAngle), m = Math.tan(this.maxTurningAngle);
    ...
    return r.prototype = {
        type: "star", buildPath: function (e, t) {
            ...
            if (o && !(2 > o)) {
                ...
                var d = a / o, c = -a / 2, m = r + l * n(c), p = s + l * i(c);
                c += d;
                var u = t.pointList = [];
                u.push([m, p]);
    ...
    "use strict";
    var t = e("./Base"), i = e("./util/PathProxy"), n = e("../tool/area"), a = function (e) {
    ...
    return i.prototype = {
        type: "bezier-curve", buildPath: function (e, t) {
            ...
            if (e.__rect)return e.__rect;
            var t = Math.min(e.xStart, e.xEnd, e.cpX1), i = Math.min(e.yStart, e.yEnd, e.cpY1), n = Math.max(e.xStart, e.xEnd, e.cpX1), a = Math.max(e.yStart, e.yEnd, e.cpY1), o = e.cpX2, r = e.cpY2;
            "undefined" != typeof o && "undefined" != typeof r && (t = Math.min(t, o), i = Math.min(i, r), n = Math.max(n, o), a = Math.max(a, r));
            var s = e.lineWidth || 1;
            return e.__rect = {x: t - s, y: i - s, width: n - t + s, height: a - i + s}, e.__rect
        }
    }, e("../tool/util").inherits(i, t), i
    ...
    return function (e, i, n, a) {
        ...
        for (var u = 0, V = e.length; V > u; u++) {
            ...
            var g = t.distance(U, o), f = t.distance(U, r), y = g + f;
            0 !== y && (g /= y, f /= y), t.scale(c, d, -g), t.scale(m, d, f);
            var b = t.add([], U, c), _ = t.add([], U, m);
    ...
    return n.prototype._buildTree = function (e, n, a, o) {
        ...
        var i = this.root, n = this._stack, a = 0, o = 1 / 0, r = null;
        for (i.data !== e && (o = t(i.data, e), r = i), e.array[i.axis] < i.data.array[i.axis] ? (i.right && (n[a++] = i.right), i.left && (n[a++] = i.left)) : (i.left && (n[a++] = i.left), i.right && (n[a++] = i.right)); a--;) {
            i = n[a];
            var s = e.array[i.axis] - i.data.array[i.axis], l = 0 > s, h = !1;
        ...
        for (a.data !== e && (d++, this._addNearest(d, h, a)), e.array[a.axis] < a.data.array[a.axis] ? (a.right && (o[r++] = a.right), a.left && (o[r++] = a.left)) : (a.left && (o[r++] = a.left), a.right && (o[r++] = a.right)); r--;) {
            a = o[r];
            var h = e.array[a.axis] - a.data.array[a.axis], c = 0 > h, m = !1;
    ...
    return t.prototype = {
        ...
        _contentToOption: function (e) {
            ...
            for (t = 0, o = c.length; o > t; t++)if (d++, c[t].type == n.CHART_TYPE_SCATTER)for (var i = 0, a = c[t].data.length; a > i; i++)s = e[d], l = s.replace(" ", "").split(","), "undefined" != typeof c[t].data[i].value ? c[t].data[i].value = l : c[t].data[i] = l, d++; else {
                s = e[d].split(",");
    ...
    return h.prototype = {
        type: "sector", buildPath: function (e, i) {
            ...
            if (e.__rect)return e.__rect;
            var a = e.x, h = e.y, d = e.r0 || 0, c = e.r, m = t.degreeToRadian(e.startAngle), p = t.degreeToRadian(e.endAngle), u = e.clockWise;
    ...
    function i(e, t, i, n, a, r) {
        ...
        var d = Math.min.apply(null, s), c = Math.max.apply(null, s), m = Math.min.apply(null, h), p = Math.max.apply(null, h);
    ...
    function n(e, t, i, n, a) {
        ...
        var l = 1 - r, h = 1 - s, d = l * l * e[0] + 2 * l * r * t[0] + r * r * i[0], c = l * l * e[1] + 2 * l * r * t[1] + r * r * i[1], m = h * h * e[0] + 2 * h * s * t[0] + s * s * i[0], p = h * h * e[1] + 2 * h * s * t[1] + s * s * i[1];
        n[0] = Math.min(e[0], i[0], d, m), n[1] = Math.min(e[1], i[1], c, p), a[0] = Math.max(e[0], i[0], d, m), a[1] = Math.max(e[1], i[1], c, p)
    }

    var a = e("./vector"), o = e("./curve"), r = a.create(), s = a.create(), l = a.create(), h = function (e, t, i, n, o, h, d, c) {
    ...
    var i = e("./base"), n = e("zrender/shape/Rectangle"), a = e("../config");
    a.grid = {
        zlevel: 0,
        z: 0,
        x: 80,
    ...
    var i = e("./base"), n = e("zrender/shape/Rectangle"), a = e("zrender/shape/Polygon"), o = e("../util/shape/Icon"), r = e("../config");
    r.dataZoom = {
        zlevel: 0,
        z: 4,
        show: !1,
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_DATAZOOM, _buildShape: function () {
            ...
            var g = V - U, f = [], y = e / (i - (i > 1 ? 1 : 0)), b = t / (i - (i > 1 ? 1 : 0)), _ = 1;
            ...
            "horizontal" == this.zoomOption.orient ? (f.push([this._location.x + e, this._location.y + t]), f.push([this._location.x, this._location.y + t])) : (f.push([this._location.x, this._location.y]), f.push([this._location.x, this._location.y + t])), this.shapeList.push(new a({
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {pointList: f, color: this.zoomOption.dataBackgroundColor},
                hoverable: !1
            }))
            ...
            var d = this._zoom.seriesIndex[0], c = this.option.series[d][e + "Index"] || 0, m = this.option[e][c].type, p = this._zoom.scatterMap[d][e.charAt(0)].min, u = this._zoom.scatterMap[d][e.charAt(0)].max, V = u - p;
            if ("value" == m)return {start: p + V * this._zoom.start / 100, end: p + V * this._zoom.end / 100};
            if ("time" == m) {
                u = p + V * this._zoom.end / 100, p += V * this._zoom.start / 100;
                var U = s.getAutoFormatter(p, u).formatter;
                return {start: s.format(U, p), end: s.format(U, u)}
            }
            return {start: "", end: ""}
    ...
    var i = e("./base"), n = e("zrender/shape/Text"), a = e("zrender/shape/Line"), o = e("zrender/shape/Rectangle"), r = e("../config");
    r.categoryAxis = {
        zlevel: 0,
        z: 0,
        show: !0,
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_AXIS_CATEGORY, _getReformedLabel: function (e) {
            var t = this.getDataFromOption(this.option.data[e]), i = this.option.data[e].formatter || this.option.axisLabel.formatter;
                    ...
                    for (d = 1 > d ? 1 : d, e = Math.floor(15 / r); !h && n > e;) {
                        ...
                        for (var c = Math.floor((n - 1) / e) * e; c >= 0; c -= e) {
                            if (0 !== this.option.axisLabel.rotate)o = t; else if (i[c].textStyle)o = l.getTextWidth(this._getReformedLabel(c), this.getFont(s.merge(i[c].textStyle, this.option.axisLabel.textStyle))); else {
                                var m = this._getReformedLabel(c) + "", p = (m.match(/\w/g) || "").length, u = m.length - p;
                                o = p * t * 2 / 3 + u * t
                            }
                            if (o > a) {
                                h = !1;
            ...
            if (this.isHorizontal())for (var p, u = "bottom" == this.option.position ? n.inside ? this.grid.getYend() - o - 1 : this.grid.getYend() + 1 : n.inside ? this.grid.getY() + 1 : this.grid.getY() - o - 1, V = m; i > V; V += h)(!l || l(V, t[V])) && (p = this.subPixelOptimize(this.getCoordByIndex(V) + (V >= 0 ? c : 0), s), e = {
                ...
                z: this.getZBase(),
                hoverable: !1,
                style: {xStart: p, yStart: u, xEnd: p, yEnd: u + o, strokeColor: r, lineWidth: s}
            }, this.shapeList.push(new a(e))); else for (var U, g = "left" == this.option.position ? n.inside ? this.grid.getX() + 1 : this.grid.getX() - o - 1 : n.inside ? this.grid.getXend() - o - 1 : this.grid.getXend() + 1, V = m; i > V; V += h)(!l || l(V, t[V])) && (U = this.subPixelOptimize(this.getCoordByIndex(V) - (V >= 0 ? c : 0), s), e = {
                _axisShape: "axisTick",
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                hoverable: !1,
                style: {xStart: g, yStart: U, xEnd: g + o, yEnd: U, strokeColor: r, lineWidth: s}
            ...
            var l = s.length, h = "function" == typeof this.option.axisLabel.interval ? this.option.axisLabel.interval : !1, d = n.onGap, c = d ? this.getGap() / 2 : "undefined" == typeof d && this.option.boundaryGap ? this.getGap() / 2 : 0;
            ...
            }, this.shapeList.push(new a(e))); else for (var U, g = this.grid.getX(), f = this.grid.getXend(), V = 0; i > V; V += this._interval)(!h || h(V, t[V])) && (U = this.subPixelOptimize(this.getCoordByIndex(V) - c, r), e = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                hoverable: !1,
                style: {
            ...
            if (n instanceof Array) {
                var a = n.length, r = this.option.data.length, s = "function" == typeof this.option.axisLabel.interval ? this.option.axisLabel.interval : !1, l = i.onGap, h = l ? this.getGap() / 2 : "undefined" == typeof l && this.option.boundaryGap ? this.getGap() / 2 : 0;
                if (this.isHorizontal())for (var d, c = this.grid.getY(), m = this.grid.getHeight(), p = this.grid.getX(), u = 0; r >= u; u += this._interval)s && !s(u, t[u]) && r > u || (d = r > u ? this.getCoordByIndex(u) + h : this.grid.getXend(), e = {
                    ...
                    z: this.getZBase(),
                    hoverable: !1,
                    style: {x: p, y: c, width: d - p, height: m, color: n[u / this._interval % a]}
                }, this.shapeList.push(new o(e)), p = d); else for (var V, U = this.grid.getX(), g = this.grid.getWidth(), f = this.grid.getYend(), u = 0; r >= u; u += this._interval)s && !s(u, t[u]) && r > u || (V = r > u ? this.getCoordByIndex(u) - h : this.grid.getY(), e = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
                    style: {x: U, y: V, width: g, height: f - V, color: n[u / this._interval % a]}
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_AXIS_VALUE, _buildShape: function () {
            ...
            }, this.shapeList.push(new a(e)); else for (var c, m = "left" === this.option.position ? n.inside ? this.grid.getX() + 1 : this.grid.getX() - o - 1 : n.inside ? this.grid.getXend() - o - 1 : this.grid.getXend() + 1, d = 0; i > d; d++)c = this.subPixelOptimize(this.getCoord(t[d]), s), e = {
                _axisShape: "axisTick",
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                hoverable: !1,
                style: {xStart: m, yStart: c, xEnd: m + o, yEnd: c, strokeColor: r, lineWidth: s}
            }, this.shapeList.push(new a(e))
        }, _buildAxisLabel: function () {
            ...
            if (this.isHorizontal())for (var h, d = this.grid.getY(), c = this.grid.getYend(), m = 0; i > m; m++)h = this.subPixelOptimize(this.getCoord(t[m]), r), e = {
                ...
                z: this.getZBase(),
                hoverable: !1,
                style: {xStart: h, yStart: d, xEnd: h, yEnd: c, strokeColor: s[m % l], lineType: o, lineWidth: r}
            }, this.shapeList.push(new a(e)); else for (var p, u = this.grid.getX(), V = this.grid.getXend(), m = 0; i > m; m++)p = this.subPixelOptimize(this.getCoord(t[m]), r), e = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                hoverable: !1,
                style: {xStart: u, yStart: p, xEnd: V, yEnd: p, strokeColor: s[m % l], lineType: o, lineWidth: r}
            }, this.shapeList.push(new a(e))
        }, _buildSplitArea: function () {
            ...
            if (t instanceof Array) {
                ...
                }, this.shapeList.push(new o(e)), h = r; else for (var c, m = this.grid.getX(), p = this.grid.getWidth(), u = this.grid.getYend(), d = 0; a >= d; d++)c = a > d ? this.getCoord(n[d]) : this.grid.getY(), e = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
                    style: {x: m, y: c, width: p, height: u - c, color: t[d % i]}
            ...
            var t = this.option, i = e("../util/smartLogSteps")({
                dataMin: this._min,
                dataMax: this._max,
            ...
            if (t)for (var i = 0, n = this._valueList.length; n > i; i++)"function" == typeof t ? this._valueLabel.push(e ? t.call(this.myChart, this._valueList[i], e) : t.call(this.myChart, this._valueList[i])) : "string" == typeof t && this._valueLabel.push(e ? s.format(t, this._valueList[i]) : t.replace("{value}", this._valueList[i])); else for (var i = 0, n = this._valueList.length; n > i; i++)this._valueLabel.push(e ? e(this._valueList[i]) : this.numAddCommas(this._valueList[i]))
    ...
    function a(e, i, n, a) {
        ...
        return _ = 0, b = 0, y = 0, {min: e, max: i, secs: n, step: c, fix: p, exp: a, pnts: u}
    }
    ...
    function o(n, a, o) {
        ...
        return s = o ? X(s) : I(s), !s && (r = 0), ("" + S(s)).length > a && (r += 1, s /= 10), {c: s, e: r}
    }
    ...
    function f(e, t, i) {
        ...
        for (var g = n.length; g--;) {
            ...
            p[g] = [i, l, h, d].join(), m[g] = {secs: i, step: l, delta: h, score: d}
        }
    ...
    function a() {
        function e() {
            g > d && (g = d);
            var e = X(l(d / g)), t = W(l(d / e)), i = e * t, n = (i - m) / 2, a = X(l(r - n));
            c(a - r) && (a -= 1), f = -a * V;
        ...
        _ = [];
        var o = l(v(b) / V), r = l(v(y) / V), s = W(o), h = X(r), d = s - h, m = o - r;
    ...
    function o() {
        ...
        !m && e.reverse();
        var n = s(), a = n.value2Coord, o = a(e[0]), l = a(e[e.length - 1]);
        return o === l && (o -= 1, l += 1), {
            dataMin: o,
            dataMax: l,
            tickList: e,
