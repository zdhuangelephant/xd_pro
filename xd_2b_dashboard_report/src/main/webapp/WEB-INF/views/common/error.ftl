...
<body>
   ...
   <div class="row" >
	   	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-top: 10%;">
	   		<img src="${baseOP}/image/common/error.png" class="img-circle pull-right" style="width:80%"></img>
	   	</div>
	   	<div class="col-md-6 col-sm-6 col-xs-12" style="padding-top: 25%;">
            <h1><em class="text-danger">
				<#if errorMsg??>
					${errorMsg}
				<#else>
					系统繁忙，请稍后再试
