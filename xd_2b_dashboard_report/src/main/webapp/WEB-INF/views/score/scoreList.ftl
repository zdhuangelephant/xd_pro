...
<html lang="en">
    ...
    <section class="form-well">
        <div class="row">
			<form id="searchForm" method="post" action="/score/score_list">
 		...
 		<div class="box box-success box-solid" style="margin-bottom: 0px;">
            <div class="box-header">
                ...
                <div class="box-tools pull-right modal-open">
                	...
                	<button class="btn btn-success" onclick="exportScoreList();">导出成绩汇总表</button>
                	</#if>
                	<button class="btn btn-success" data-toggle="modal" data-target="#previewPrint">打印预览</button>
                </div>
            </div>
        </div>                   
