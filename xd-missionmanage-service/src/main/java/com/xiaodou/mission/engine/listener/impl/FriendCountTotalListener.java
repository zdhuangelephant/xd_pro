...
/**
 * @name @see com.xiaodou.mission.engine.listener.impl.FriendCountTotalListener.java
 * @CopyRright (c) 2017 by Corp.XiaodouTech
 *
 * @author <a href="mailto:zhaodan@corp.51xiaodou.com">zhaodan</a>
 * @date 2017年12月26日
 * @description 好友总数量监听器
 * @version 1.0
 */
public class FriendCountTotalListener extends AbstractEventListener {

  @Override
  public String getCurrentNum(Context context) {
    if (null != context && null != context.getCoreParam()
        && null != context.getCoreParam().getFriendCountTotal()) {
      return context.getCoreParam().getFriendCountTotal().toString();
    }
