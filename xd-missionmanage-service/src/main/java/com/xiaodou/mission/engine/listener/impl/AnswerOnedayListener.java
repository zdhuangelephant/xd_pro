...
/**
 * @name @see com.xiaodou.mission.engine.listener.impl.AnswerOnedayListener.java
 * @CopyRright (c) 2017 by Corp.XiaodouTech
 *
 * @author <a href="mailto:zhaodan@corp.51xiaodou.com">zhaodan</a>
 * @date 2017年12月26日
 * @description 单天答题数监听器
 * @version 1.0
 */
public class AnswerOnedayListener extends AbstractEventListener {

  @Override
  public String getCurrentNum(Context context) {
    if (null != context && null != context.getCoreParam()
        && null != context.getCoreParam().getAnswerOneday()) {
      return context.getCoreParam().getAnswerOneday().toString();
    }
