...
/**
 * @name @see com.xiaodou.mission.engine.listener.impl.TollgateOnestarListener.java
 * @CopyRright (c) 2017 by Corp.XiaodouTech
 *
 * @author <a href="mailto:zhaodan@corp.51xiaodou.com">zhaodan</a>
 * @date 2017年12月26日
 * @description 一星通过闯关监听器
 * @version 1.0
 */
public class TollgateOnestarListener extends AbstractEventListener {

  @Override
  public String getCurrentNum(Context context) {
    if (null != context && null != context.getCoreParam()
        && null != context.getCoreParam().getTollgateOnestarCount()) {
      return context.getCoreParam().getTollgateOnestarCount().toString();
    }
