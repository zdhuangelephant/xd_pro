...
/**
 * @name @see com.xiaodou.mission.engine.listener.impl.FollowCountOnedayListener.java
 * @CopyRright (c) 2017 by Corp.XiaodouTech
 *
 * @author <a href="mailto:zhaodan@corp.51xiaodou.com">zhaodan</a>
 * @date 2017年12月26日
 * @description 每天关注人数监听器
 * @version 1.0
 */
public class FollowCountOnedayListener extends AbstractEventListener {

  @Override
  public String getCurrentNum(Context context) {
    if (null != context && null != context.getCoreParam()
        && null != context.getCoreParam().getFollowCountOneday()) {
      return context.getCoreParam().getFollowCountOneday().toString();
    }
