...
/**
 * @name @see com.xiaodou.mission.engine.listener.impl.FriendCountOnedayListener.java
 * @CopyRright (c) 2017 by Corp.XiaodouTech
 *
 * @author <a href="mailto:zhaodan@corp.51xiaodou.com">zhaodan</a>
 * @date 2017年12月26日
 * @description 单天好友数量监听器
 * @version 1.0
 */
public class FriendCountOnedayListener extends AbstractEventListener {

  @Override
  public String getCurrentNum(Context context) {
    if (null != context && null != context.getCoreParam()
        && null != context.getCoreParam().getFriendCountOneday()) {
      return context.getCoreParam().getFriendCountOneday().toString();
    }
