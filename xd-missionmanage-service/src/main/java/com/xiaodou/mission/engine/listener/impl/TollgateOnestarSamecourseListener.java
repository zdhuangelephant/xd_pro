...
/**
 * @name @see com.xiaodou.mission.engine.listener.impl.TollgateOnestarSamecourseListener.java
 * @CopyRright (c) 2017 by Corp.XiaodouTech
 * 
 * @author <a href="mailto:zhaodan@corp.51xiaodou.com">zhaodan</a>
 * @date 2017年12月26日
 * @description 同课程一星通过监听器
 * @version 1.0
 */
public class TollgateOnestarSamecourseListener extends AbstractEventListener {
  ...
  public String getCurrentNum(Context context) {
    if (null != context && null != context.getCoreParam()
        ...
        && null != context.getCoreParam().getTollgateInfo().getTollgateOnestarCountSamecourse()) {
      return context.getCoreParam().getTollgateInfo().getTollgateOnestarCountSamecourse()
          .toString();
    }
