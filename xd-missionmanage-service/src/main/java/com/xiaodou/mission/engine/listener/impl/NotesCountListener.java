...
/**
 * @name @see com.xiaodou.mission.engine.listener.impl.NotesCountListener.java
 ...
 * @version 1.0
 */
public class NotesCountListener extends AbstractEventListener {

  @Override
  public String getCurrentNum(Context context) {
    if (null != context && null != context.getCoreParam()
        && null != context.getCoreParam().getNotesCount()) {
      return context.getCoreParam().getNotesCount().toString();
    }
