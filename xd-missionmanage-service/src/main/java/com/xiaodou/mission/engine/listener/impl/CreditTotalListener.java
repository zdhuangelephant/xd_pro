...
/**
 * @name @see com.xiaodou.mission.engine.listener.impl.CreditTotalListener.java
 ...
 * @version 1.0
 */
public class CreditTotalListener extends AbstractEventListener {

  @Override
  public String getCurrentNum(Context context) {
    if (null != context && null != context.getCoreParam()
        && null != context.getCoreParam().getCreditTotal()) {
      return context.getCoreParam().getCreditTotal().toString();
    }
