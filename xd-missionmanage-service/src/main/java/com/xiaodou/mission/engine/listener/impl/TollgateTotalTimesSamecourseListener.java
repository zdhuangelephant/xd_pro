...
/**
 * @name @see com.xiaodou.mission.engine.listener.impl.TollgateTotalTimesSamecourseListener.java
 ...
 * @version 1.0
 */
public class TollgateTotalTimesSamecourseListener extends AbstractEventListener {
  ...
  public String getCurrentNum(Context context) {
    if (null != context && null != context.getCoreParam()
        ...
        && null != context.getCoreParam().getTollgateInfo().getTollgateTotalTimesSamecourse()) {
      return context.getCoreParam().getTollgateInfo().getTollgateTotalTimesSamecourse().toString();
    }
