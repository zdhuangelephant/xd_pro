...
/**
 * @name @see com.xiaodou.mission.engine.listener.impl.PkWinTimesSamepersonListener.java
 * @CopyRright (c) 2017 by Corp.XiaodouTech
 * 
 * @author <a href="mailto:zhaodan@corp.51xiaodou.com">zhaodan</a>
 * @date 2017年12月26日
 * @description 针对同一用户PK胜利次数监听器
 * @version 1.0
 */
public class PkWinTimesSamepersonListener extends AbstractEventListener {
  ...
  public String getCurrentNum(Context context) {
    if (null != context && null != context.getCoreParam()
      ...
      return context.getCoreParam().getPkInfo().getPkWinTimesSameperson().toString();
    }
