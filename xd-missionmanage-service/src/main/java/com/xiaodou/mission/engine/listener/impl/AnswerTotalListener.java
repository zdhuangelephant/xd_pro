...
/**
 * @name @see com.xiaodou.mission.engine.listener.impl.AnswerTotalListener.java
 ...
 * @version 1.0
 */
public class AnswerTotalListener extends AbstractEventListener {

  @Override
  public String getCurrentNum(Context context) {
    if (null != context && null != context.getCoreParam()
        && null != context.getCoreParam().getAnswerTotal()) {
      return context.getCoreParam().getAnswerTotal().toString();
    }
