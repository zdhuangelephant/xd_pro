...
public class MyTransformer implements ClassFileTransformer {
    ...
    public MyTransformer() {
        add("com.xiaodou.apps.TimeTest.sayHello");
        add("com.xiaodou.apps.TimeTest.sayHello2");
    }
        ...
        if (methodMap.containsKey(className)) {// 判断加载的class的包路径是不是需要监控的类
            ...
            try {
               ...
               for (String methodName : methodMap.get(className)) {
                    ...
                    System.out.print(newMethodName);
...
/*                    String traceId=UserTokenWrapper.getWrapper().getTraceId();
                    System.out.print("业务ID"+traceId);*/
               }
