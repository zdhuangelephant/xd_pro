...
public class WayBill implements Serializable  {
	...
	/**邮寄实体 发票*/
	public static final Integer POST_ITEM_INVOICE = 0;
	/**邮寄实体 货品*/
	public static final Integer POST_ITEM_PRODUCT = 1;
	/**邮寄实体 货品+发票*/
	public static final Integer POST_ITEM__INVOICE_PRODUCT = 2;
	...
	private String productTypeLike;
	...
	private Timestamp orderCompleteTimeNotNull;
	
	private Timestamp orderCompleteTimeLike;
	...
	public String getProductTypeLike() {
		return productTypeLike;
	}

	public void setProductTypeLike(String productTypeLike) {
		this.productTypeLike = productTypeLike;
	}

	public Timestamp getOrderCompleteTimeNotNull() {
		return orderCompleteTimeNotNull;
	}

	public void setOrderCompleteTimeNotNull(Timestamp orderCompleteTimeNotNull) {
		this.orderCompleteTimeNotNull = orderCompleteTimeNotNull;
	}

	public Timestamp getOrderCompleteTimeLike() {
		return orderCompleteTimeLike;
	}

	public void setOrderCompleteTimeLike(Timestamp orderCompleteTimeLike) {
		this.orderCompleteTimeLike = orderCompleteTimeLike;
	}
