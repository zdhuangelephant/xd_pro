...
import com.xiaodou.course.model.message.MongoCacheDTO;
...
public class MongoCacheWorker extends AbstractDefaultWorker {
    ...
    /** serialVersionUID */
    private static final long serialVersionUID = -7751325459760710130L;


    @Override
    public void domain(DefaultMessage message, IMQCallBacker<DefaultMessage> callback) {
        PageManager pageManager = SpringWebContextHolder.getBean("pageManager");
        MongoCacheDTO dto = FastJsonUtil.fromJson(message.getMessageBodyJson(), MongoCacheDTO.class);
        if (null != dto) {
