...
public class UserChapterRecordVo {
  ...
  /** relationItem 关联id update:2018-02-10 */
  ...
  public Long getResourceType() {
    return resourceType == CourseConstant.RESOURCE_TYPE_COURSE
        ? parentId == 0l ? CourseConstant.RESOURCE_TYPE_CHAPTER : CourseConstant.RESOURCE_TYPE_ITEM
        : resourceType;
  }
