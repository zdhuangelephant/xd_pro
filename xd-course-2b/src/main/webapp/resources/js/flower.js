...
Zepto(function($){
    ...
    if(localStorage.a % 2 ==0){
        text1=decodeURI("%E6%9C%89%E5%AF%B9%E8%B1%A1");
        text2=decodeURI("%E5%8D%95%E8%BA%AB%E7%8B%97");
    }
    //云彩动画
...
//定义数组，存放各花瓣top,left
    ...
    $(".leafTween").each(function(){
        $(this).bind("click", function () {
            ...
            time++;
            if (time % 2 == 1) {
                $("#face").css('background-image', "url('http://7xlos1.com1.z0.glb.clouddn.com/hehe.png')");
                $(".topText").html(text1);
            } else {
                $("#face").css('background-image', "url('http://7xlos1.com1.z0.glb.clouddn.com/cry.png')");
                $(".topText").html(text2);
            }
            if (dropTimeList.indexOf(time) != -1) {
                //拔掉2个
                $("#face").css('background-image', "url('http://7xlos1.com1.z0.glb.clouddn.com/aaa_03.png')");
            }
