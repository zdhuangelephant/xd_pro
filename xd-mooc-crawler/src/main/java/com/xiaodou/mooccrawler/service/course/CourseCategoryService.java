...
import com.xiaodou.mooccrawler.dao.course.CourseCategoryDao;
...
import com.xiaodou.mooccrawler.web.request.CategoryCreateRequest;
import com.xiaodou.mooccrawler.web.request.CategoryEditRequest;
import com.xiaodou.mooccrawler.web.response.CategoryCreateResponse;
import com.xiaodou.mooccrawler.web.response.CategoryEditResponse;
...
/*    if (entity.getParentId()!=null){
   ...
   * @return
   */
  public CourseCategoryModel findCategoryById(Integer catId){
   ...
   * @return
   */
  public String categoryTableTree(Integer parentId){
   ...
   * @return
   */
  public String categorySelectTree(Integer parentId,String selectedId){
    List<CourseCategoryModel> categoryList = this.queryAllChildCategory(parentId);
    Map<String,TreeNode> treeNodeMap = new HashMap();
    for (CourseCategoryModel courseCategory:categoryList){
      TreeNode treeNode = new TreeNode();
   ...
   * @return
   */
  public String categoryJqueryTree(Integer parentId,String parentTemplate,String childTemplate){
    List<CourseCategoryModel> categoryList = this.queryAllChildCategory(parentId);
    Map<String,TreeNode> treeNodeMap = new HashMap();
    for (CourseCategoryModel courseCategory:categoryList){
      TreeNode treeNode = new TreeNode();
  ...
  public List<CourseCategoryModel> queryCategoryByParentId(Integer parentId) {
    ...
    output.put("level","");
    output.put("isLeaf","");
    Page<CourseCategoryModel> categoryList = courseCategoryDao.queryListByCondWithOutPage(cond, output);
   ...
   * @return
   */
  public Map<Integer,CourseCategoryModel> queryAllCategoryMap() {
    List<CourseCategoryModel> courseCategoryModelList = this.queryAllCategory();
    Map<Integer,CourseCategoryModel> resultMap = new HashMap<>();
   ...
   * @return
   */
  public List<CourseCategoryModel> queryAllChildCategory(Integer id){
    if (id==0){
  ...
  public Boolean cleanTree() {
    ...
    List<CourseCategoryModel> courseCategoryModelList = this.queryAllCategory();
    //2.栏目ID
    Map<Integer, CourseCategoryModel> idMap = new HashMap<>();
    for (CourseCategoryModel categoryModel : courseCategoryModelList) {
      idMap.put(categoryModel.getId(), categoryModel);
    }
    //3.父栏目ID
    Map<Integer, List<CourseCategoryModel>> parentIdMap = new HashMap<>();
    for (CourseCategoryModel categoryModel : courseCategoryModelList) {
   ...
   * @return
   */
  private List<CourseCategoryModel> parentList(Map<Integer,CourseCategoryModel> idMap,Integer catId){
   ...
   * @return
   */
  private List<CourseCategoryModel> allChildId(Map<Integer,List<CourseCategoryModel>> parentIdMap,Integer catId){
    List<CourseCategoryModel> result = new ArrayList<>();
