            ...
            if (index > 0) {
                ...
                page.onReady = function () {
                    ...
                    if (order % 3 == 2) {//第二页
                        ...
                        //图片动画
                        TweenMax.from("#" + page.id + " .picture img", 0.3, {
                            opacity: 0,
                            delay: 1.1,
                            ease: Power2.easeOut
                        });
                    ...
                    if (order % 3 == 0) {
                        ...
                        TweenMax.from("#" + page.id + " .exam .move2", 0.2, {
                            ...
                            , delay: 0.7, onComplete: function () {
                                ...
                                TweenMax.to("#" + page.id + " .exam .move2", 0.3, {
                                    width: "100%",
                                    ease: Power2.easeOut,
                                    delay: 0.1
                                });
                                TweenMax.to("#" + page.id + " .exam .move2 .cartoon", 0.3, {
                                    display: "block",
                                    opacity: 1,
                                    delay: 0.3
                                });
                                TweenMax.to("#" + page.id + " .exam .move2 .type", 0.3, {
                                    display: "block",
                                    opacity: 1,
                                    delay: 0.3
                                });
                ...
                page.onEnter = function () {
                    ...
                    hash = getText($("#" + currentPageId + " .yy-click"));
