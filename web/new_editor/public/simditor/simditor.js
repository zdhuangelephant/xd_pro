...
var BlockquoteButton, BoldButton, Button, CodeButton, CodePopover, ColorButton, Formatter, HrButton,UndoButton, ImageButton, ImagePopover, IndentButton, Indentation, InputManager, ItalicButton, Keystroke, LinkButton, LinkPopover, ListButton, OrderListButton, OutdentButton, Popover, Selection, Simditor, SourceButton, StrikethroughButton, TableButton, TitleButton, Toolbar, UnderlineButton, UndoManager, UnorderListButton, Util,
...
//      this.wrapper.css('top', this.opts.toolbarFloatOffset);
  ...
  Toolbar.prototype._render = function() {
    ...
    if (this.opts.toolbarHidden) {
      ...
      return this.editor.placeholderEl;
    }
  };
  ...
  ImageButton.prototype._initUploader = function($uploadItem) {
    ...
    createInput = (function(_this) {
      return function() {
        ...
        return $input = $('<input type="file" name="fileData" title="' + _this._t('uploadImage') + '" accept="image/*">').appendTo($uploadItem);
      };
    })(this);
    createInput();
  ...
  ImagePopover.prototype._initUploader = function() {
    ...
    createInput = (function(_this) {
      return function() {
        ...
        return _this.input = $('<input type="file" name="fileData" title="' + _this._t('uploadImage') + '" accept="image/*">').appendTo($uploadBtn);
      };
    })(this);
    createInput();
...
UndoButton = (function(superClass) {
    ...
    UndoButton.prototype.icon = 'upload';

    UndoButton.prototype.htmlTag = 'undo';

    UndoButton.prototype.status = function($node) {
        return true;
    };
