...
public class JzUserInfoRegist extends RegistAccountRequest {
  ...
  public String setMoudelInfo(Map<String, Object> moudelInfoMap) {
    JzUserInfo userInfo = new JzUserInfo();
    if (null != moudelInfoMap.get("city")) userInfo.setCity((Integer) moudelInfoMap.get("city"));
    ...
    if (null != moudelInfoMap.get("type")) userInfo.setType((Integer) moudelInfoMap.get("type"));
