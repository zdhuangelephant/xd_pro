...
import com.xiaodou.userCenter.request.NewRegistAccountRequest;
import com.xiaodou.userCenter.request.UserBaseInfo;

/**
 * @name JzUserInfoNewRegist CopyRright (c) 2015 by <a
 ...
 * @waste
 */
public class JzUserInfoNewRegist extends NewRegistAccountRequest {

  public JzUserInfoNewRegist() {
    this(null);
  }

  public JzUserInfoNewRegist(UserBaseInfo info) {
    super(info);
  }
