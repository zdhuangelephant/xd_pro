    ...
    return {
        ...
        init: function () {
            ...
            function saveRow(oTable, nRow) {
                ...
                oTable.fnDraw();
                $.post("/jmsg/queueAdd", {id:nRow.cells[0].id,queueName:jqInputs[0].value,qos:jqInputs[1].value,parallelCount:jqInputs[2].value},
	                    function(data){
            ...
            $('#sample_editable_2 a.delete').live('click', function (e) {
                ...
                $.post("/jmsg/queueDel", {id:nRow.cells[0].id},
	                    function(data){
	                        var u=JSON.parse(data);   
	                        if(u.msg=="true"){
	                          alert("成功");
