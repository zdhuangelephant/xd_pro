...
import com.xiaodou.st.dataclean.model.domain.raw.RawDataProductScorePointRule.RuleInfo;

import lombok.Data;

/**
 * @name @see
 *       com.xiaodou.st.dataclean.model.domain.raw.RawDataUserScorePointRecord
 *       .java
...
public class RawDataUserScorePointRecord {
	...
	public static void main(String[] args) {
		MybatisXmlTool.getInstance(RawDataUserScorePointRecord.class,
				"xd_raw_data_user_score_point_record",
