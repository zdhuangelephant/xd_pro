...
public class IDGenerator {
  ...
  public static String getSeqID() {
    HiLoGenerator idGenerator = HiLoGenerator.getIDGenerator("xd_payment_sequence_id");
  ...
  public static String getSeqTradeNo(int businessType) {
    HiLoGenerator idGenerator = HiLoGenerator.getIDGenerator("xd_payment_sequence_token");
    long subID = idGenerator.getNextID((byte) 0);
