package com.xiaodou.server.pay.web.filter;
...
import com.xiaodou.summer.web.filter.ControllerInterceptor;
 ...
 * @version 1.0
 */
public class PayControllerInterceptor extends ControllerInterceptor {
