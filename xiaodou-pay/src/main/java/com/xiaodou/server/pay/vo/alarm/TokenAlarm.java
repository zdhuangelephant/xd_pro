 ...
 * @date 2017年6月19日
 * @description Token接口报警类
 * @version 1.0
 */
public class TokenAlarm extends AlarmEntityImpl {

  private String eventModule = "xd-pay";
  private String eventName = "token-fail";
  private String messageInfo = "获取token接口异常. %s";
  private String mailInfo = "获取token接口异常. %s";

  public TokenAlarm(String message) {
