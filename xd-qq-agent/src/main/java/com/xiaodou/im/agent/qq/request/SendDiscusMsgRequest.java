 ...
 * @author Tian.Dong
 */
public class SendDiscusMsgRequest extends BaseRequest {
  @TransField("r")
  private String r;
  ...
  public void setR(SendDiscusMsgRContent content) {
   ...
   * }
   */
  public static class SendDiscusMsgRContent {
    @JSONField(name = "did")
    private long did;
  ...
  public String getUrl() {
    ...
    return "http://d.web2.qq.com/channel/send_discu_msg2";
  }
