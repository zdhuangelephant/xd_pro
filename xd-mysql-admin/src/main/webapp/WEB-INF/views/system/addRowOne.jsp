...
<body>
<div>
	<form id="mainform" action="${ctx }/system/permission/i/saveRows" method="post">
		    ...
		    <c:choose>
               <c:when test="${entity.data_type == 'DATETIME' }" >  
                   ...
                   <tr>
				     ...
				     <td><input name="${entity.column_name }" type="text" class="easyui-my97" datefmt="yyyy-MM-dd"  style="width:150"  <c:if test="${entity.is_nullable == 0 }"> data-options=" required:'required' " </c:if>   /></td>
			       </tr>
               ...
               <c:when test="${entity.data_type == 'INT'|| entity.data_type == 'SMALLINT' }" > 
                  <tr>
				    <td>    <c:out value="${entity.column_name }"/>：</td>
				    <td><input name="${entity.column_name }" type="text"  class="easyui-numberbox"   style="width:150 "   <c:if test="${entity.is_nullable ==0 }"> data-options=" required:'required'" </c:if>  /></td>
			      </tr>
                ...
                <c:otherwise>                 
                   <tr>
				    <td>   <c:out value="${entity.column_name }"/>：</td>
				    <td><input name="${entity.column_name }" type="text"  class="easyui-validatebox"   style="width:150"  <c:if test="${entity.is_nullable == 0 }"> data-options=" required:'required'" </c:if>   /></td>
			      </tr>
