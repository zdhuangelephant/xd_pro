...
function initData(){
	dgg=$('#dg3').datagrid({     
	method: "get",
    url: '${ctx}/system/permission/i/configList', 
    fit : true,
	fitColumns : true,
	border : false,
	idField : 'sid',
    ...
    columns:[[    
	  	...
	  	{field:'sid',title:'id',sortable:true,width:30},
	  	{field:'dataSourceName',title:'数据源名称',width:100 },
        {field:'ip',title:'数据源地址',sortable:true,width:100},
