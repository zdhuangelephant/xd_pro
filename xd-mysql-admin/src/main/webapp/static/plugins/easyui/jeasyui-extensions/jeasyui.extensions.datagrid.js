...
(function ($, undefined) {
    ...
    var editors = $.fn.datagrid.defaults.editors,
        ...
        //datetimebox_init = editors.datetimebox.init,
    ...
    $.extend(editors.datebox, {
     ...
     $.extend(editors.datetimebox, {  
        init: function(container, options){  
            var editor3 = $('<input />').appendTo(container);  
            editor3.enableEdit = false;  
            editor3.datetimebox(options);  
            return editor3;  
        },  
