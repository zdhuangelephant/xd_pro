...
public class Reflections {
  ...
  public static void makeAccessible(Method method) {
    if (((Modifier.isPublic(method.getModifiers())) && (Modifier.isPublic(method
        .getDeclaringClass().getModifiers()))) || (method.isAccessible())) return;
  ...
  public static void makeAccessible(Field field) {
    if (((Modifier.isPublic(field.getModifiers()))
        && (Modifier.isPublic(field.getDeclaringClass().getModifiers())) && (!Modifier
          .isFinal(field.getModifiers()))) || (field.isAccessible())) return;
  ...
  public static RuntimeException convertReflectionExceptionToUnchecked(Exception e) {
    if ((e instanceof IllegalAccessException) || (e instanceof IllegalArgumentException)
        || (e instanceof NoSuchMethodException)) return new IllegalArgumentException(e);
