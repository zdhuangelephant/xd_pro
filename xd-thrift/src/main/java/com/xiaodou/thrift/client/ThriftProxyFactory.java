...
/**
 * @name ThriftProxyFactory CopyRright (c) 2018 by 李德洪
 * 
 * @author 李德洪
 * @date 2018年1月7日
 * @description 接口代理实现，使用HttpClient实现远程调用
 * @version 1.0
 */
public class ThriftProxyFactory implements ObjectFactory {
  ...
  public Object getObjectInstance(Object obj, Name name, Context nameCtx,
    ...
    if (url == null) throw new NamingException("`url' must be configured for ThriftProxyFactory.");
