...
public interface UcenterModelConstant {
  ...
  public static String DEFAULT_NAME = "慕享";
  ...
  public static final String PORTRAIT =
      ...
      "http://resource.51xiaodou.com/user/excel/o_1borgus1412q781f19fst26vnab.jpg";
  ...
  /* student */
  /* 学生状态 0、未注册，1、注册成功，2、注册失败 ，3、注册异常，4、成功导入*/
  ...
  public static final String WALLET_PRODUCT_LINE = "2";
