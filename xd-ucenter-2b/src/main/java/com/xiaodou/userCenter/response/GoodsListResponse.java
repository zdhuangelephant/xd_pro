 ...
 * @version 1.0
 */
public class GoodsListResponse extends BaseResultInfo {

  public GoodsListResponse(ResultType type) {
    super(type);
  }
  ...
  public static class Good {
    ...
    public Good(AccountWalletGood good) {
      this.id = good.getId();
      this.productLine = good.getProductLine();
