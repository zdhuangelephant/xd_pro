...
public class UserRankResponse extends BaseResultInfo {
  ...
  private RankUserInfo myRankInfo = new RankUserInfo();
  private List<RankUserInfo> rankInfoList = Lists.newArrayList();

  public RankUserInfo getMyRankInfo() {
    return myRankInfo;
  }
  public void setMyRankInfo(RankUserInfo myRankInfo) {
  ...
  public void setRankInfoList(List<RankUserInfo> rankInfoList) {
