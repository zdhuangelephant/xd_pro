...
public class ExamDetailPojo_v1_3_8 extends QuesBasePojo {
  ...
  public Errors validate() {
    ...
    if (ExamType.RANDOM_CHALLENGE_PAPER.equals(exam)
        || ExamType.FRIEND_CHALLENGE_PAPER.equals(exam) || ExamType.DAILY_PRACTICE.equals(exam)) {
      setChapterId("-1");
