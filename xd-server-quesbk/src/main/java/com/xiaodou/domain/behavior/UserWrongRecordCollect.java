...
public class UserWrongRecordCollect extends BaseEntity {
  ...
  /** parentListOrder 父节点排序字段 */
  private Long parentListOrder;
  /**
   * 问题数量
   */
  ...
  public Long getParentListOrder() {
    return parentListOrder;
  }

  public void setParentListOrder(Long parentListOrder) {
    this.parentListOrder = parentListOrder;
  }
