...
public class UserOrderModel extends BaseEntity {
	/** id 主键 */
	...
	public static void main(String[] args) {
		MybatisXmlTool
				.getInstance(UserOrderModel.class,
						"xd_course_product_order_record",
						"F:/xdworks/xd-server-quesbk-rebuild/src/main/resources/conf/mybatis/behavior/")
				.buildXml();
		;
	}
