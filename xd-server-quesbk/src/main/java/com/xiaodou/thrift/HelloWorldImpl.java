...
import com.xiaodou.thrift.route.DefaultModel;
// import com.xiaodou.thrift.annotion.ThriftMethod;
// import com.xiaodou.thrift.annotion.ThriftService;
import com.xiaodou.util.ThriftUtil;

public class HelloWorldImpl extends ScanPath implements HelloWorld.Iface {

  @Override
  // public String sayHello(String username) throws TException {
  // System.out.println("客户端调用服务端了！！！");
  ...
  public String sayHello(String username) throws TException {
    ...
    // DefaultModel defaultModel = this.routeService(CourseProductDao.class.toString(),
    // "selectById", productId);
    // System.out.println(defaultModel.getModel());
    a();
    return "hello world, " + username;
  }
  ...
  public void a() {
    ...
    try {
      defaultModel =
          this.routeService(CourseProductDao.class.getSimpleName(), "selectById",
              FastJsonUtil.toJson(transferParam));
      System.out.println(defaultModel.getModel());
    } catch (TException e) {
      e.printStackTrace();
    }
  ...
  public static void main(String[] args) throws IllegalAccessException, IllegalArgumentException,
      InvocationTargetException, InstantiationException, TException {
//    TransferParam transferParam = new TransferParam();
//    transferParam.add("1");
//    HelloWorldImpl h = new HelloWorldImpl("com.xiaodou.dao.product");
//    DefaultModel defaultModel =
//        h.routeService(CourseProductDao.class.getSimpleName(), "selectById",
//            FastJsonUtil.toJson(transferParam));
//    System.out.println(defaultModel.getModel());
   ...
   * @return
   */
  public HelloWorldImpl(String scanPath) {
    super(scanPath);
  }
