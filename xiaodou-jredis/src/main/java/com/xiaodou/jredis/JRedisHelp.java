...
public class JRedisHelp {
  ...
  public static class PassportUserDetail implements Serializable {
    ...
    public String toString() {
      return "PassportUserDetail [id=" + id + ", username=" + username + ", realname=" + realname
          + ", password=" + password + ", ext=" + ext + ", email=" + email + ", phone=" + phone
          + ", userType=" + userType + ", status=" + status + ", roles=" + roles + ", supplierId="
          + supplierId + ", supplierOrgId=" + supplierOrgId + "]";
    }
  }
