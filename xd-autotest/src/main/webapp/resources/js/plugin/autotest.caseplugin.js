                    ...
                    getHtml: function () {
                    	...
                    	if(_option && _option.docSpanMethod && _option.docSpanMethod.length > 0) {
                    		for(var methodIndex in _option.docSpanMethod) {
                    			...
                    			if(method.showName=="分享"){
                    				if(_share=="1"){
                    					methodHtml += '<span href="javascript:" onclick="'+ method.name +'(event,\'' + _docId + '\',\'' + _docName + '\',\'' + _share + '\')">取消分享</span>'
                    				}else{
                    					methodHtml += '<span href="javascript:" onclick="'+ method.name +'(event,\'' + _docId + '\',\'' + _docName + '\',\'' + _share + '\')">分享</span>'
                    				}
                        ...
                        var html = '<p class="green">'  
                        	...
                        	+ methodA
                        	+ '<a class="r-more-option r-more-option-ok">' + '···' 
                        	+ '<span class="option-list-wrap option-list-wrap-case">' + methodHtml + '</span>'
                        	+ '</a>'
                            + '</span>'
                            + '</p>'
                            + '<ul>';
