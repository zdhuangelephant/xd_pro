...
public class CaseRequest {
	...
	@GeneralField
	@Column(canUpdate = true, sortBy = false)
	private String caseRequestDesc;
	/** 默认方法 */
	@GeneralField
	@Column(canUpdate = true, sortBy = false)
	...
	public String getCaseRequestDesc() {
		return caseRequestDesc;
	}

	public void setCaseRequestDesc(String caseRequestDesc) {
		this.caseRequestDesc = caseRequestDesc;
	}
	...
	public static void main(String[] args) {
		MybatisXmlTool.getInstance(CaseRequest.class, "case_request",
