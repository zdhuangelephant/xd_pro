...
public class UserExamTotalRank extends SummerTask {
  ...
  public UserExamTotalRank(QuesBatchProService proService, UserExamTotal myExam, Integer selfRank) {
    this.myExam = myExam;
  ...
  public void run() {
    ...
    try {
      // 针对单个学生平均全部答题排名
      proService.updateNotAllUserTotal(myExam, selfRank);
    } catch (Exception e) {
