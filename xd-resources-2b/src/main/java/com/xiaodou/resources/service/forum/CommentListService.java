...
import com.xiaodou.resources.response.forum.IgnoreRelateCommentsResponse;
import com.xiaodou.resources.response.forum.MyCommentResponse;
import com.xiaodou.resources.response.forum.RelateCommentResponse;
...
public class CommentListService {
  ...
  public MyCommentResponse getMyComment(MyCommentRequest request) throws Exception {
    ...
    List<MyComment> list =
        queryMyComment(request.getUid(), request.getSize(), null,
  ...
  private List<MyComment> queryMyComment(String userId, Integer size, String ids, String commentId) {
    ...
    for (CommentForumModel model : comments) {
      try {
        ...
        comment.setForumId(model.getResourcesId().toString());
        ...
        comment.setPublisherNickName(this.getPublisherNickName(model.getResourcesId()));
  ...
  public RelateCommentResponse myRelateComments(RelateCommentsRequest pojo) {
    ...
    response.setList(queryRelateComments(pojo.getUid(), pojo.getSize(), null,
        pojo.getIdUpper()));
    return response;
  }
  ...
  public List<RelateComment> queryRelateComments(String userId, Integer size, String ids,
    ...
    for (RelateInfoUserModel model : comments) {
      try {
        ...
        relateComment.setForumId(model.getResourcesId().toString());
        ...
        inputArgument.put("forumId", model.getResourcesId());
        ...
        ForumUserModel forumUserModel =
            forumServiceFacade.queryForumUserById(model.getResourcesId().toString());
  ...
  public IgnoreRelateCommentsResponse ignoreRelateComments(IgnoreRelateCommentsRequest pojo) {
    forumServiceFacade.updateMyRelateInfoIgnore(pojo.getUid());
