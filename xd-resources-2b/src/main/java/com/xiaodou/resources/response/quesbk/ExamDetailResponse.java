...
import com.xiaodou.resources.model.quesbk.CourseKeyword;
import com.xiaodou.resources.model.quesbk.QuesbkAnswer;
import com.xiaodou.resources.model.quesbk.QuesbkAnswerList;
import com.xiaodou.resources.model.quesbk.QuesbkExamPaper;
import com.xiaodou.resources.model.quesbk.QuesbkQues;
import com.xiaodou.resources.model.quesbk.QuesbkQues.KeyPoint;
import com.xiaodou.resources.model.quesbk.QuesbkQues.Statistic;
import com.xiaodou.resources.response.BaseResponse;
import com.xiaodou.resources.response.quesbk.QuesDetailResponse.Answer;
...
public class ExamDetailResponse extends BaseResponse {
  ...
  public static class ExamDetail {
     ...
     * 问题数量
     */
    private String quesCount = "0";
    /** rightCount 答对数量 */
    private String rightCount = "0";
    /**
     * 上次练习耗时(继续练习使用字段)
     */
    ...
    public void setItemInfo(ProductItemModel item) {
      if (null == item) return;
