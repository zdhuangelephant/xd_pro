  ...
  * 查看该文档的所有接口列表。
  **/
 $("button[name='findDoc']").click(function(){
   ...
   $.main.refreshMain('/doc/query_doc', option);
 });

 /**
  * 点击查看当前md文档。
  * **/
 $("button[name='viewDocDetail']").click(function(){
   var apiDoc_uniqid=$(this).attr('uniqid');
   var option = {
     method:"post",
     data:{
   ...
   $.main.refreshRight('/doc/show_doc_detail', option);
 });

 $("button[name='deleteDoc']").click(function(){
   var apiDoc_uniqid=$(this).attr('uniqid');
   var option = {
     method:"post",
     data:{
