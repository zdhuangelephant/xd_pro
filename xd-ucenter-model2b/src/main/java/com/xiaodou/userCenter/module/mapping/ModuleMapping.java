...
public enum ModuleMapping {
  ...
  Maping_2(
      "小逗自考", StUserInfo.class, StUserInfoRegist.class,StOfficialInfoRegist.class,StUserInfoModify.class, StUserInfoResponse.class,
      StConfigVersionResponse.class, StConfigRequest.class, StConfigResponse.class,
      new StConfigService(), StUserInfoNewLogin.class,  StFriend.class);
  private ModuleMapping(String name, Class<? extends BaseUserInfo> model,
      Class<? extends RegistAccountRequest> regist,Class<? extends OfficialRegistRequest> officialregist,
      Class<? extends ModifyMyInfoRequest> modify,
