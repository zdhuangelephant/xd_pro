...
import com.xiaodou.common.io.UnsafeStringWriter;
import com.xiaodou.common.util.constant.Constant;
...
public class StringUtils extends org.apache.commons.lang.StringUtils {
  ...
  public static boolean isContains(String values, String value) {
    ...
    return isContains(Constant.COMMA_SPLIT_PATTERN.split(values), value);
  }
  ...
  public static String getServiceKey(Map<String, String> ps) {
    ...
    String group = ps.get(Constant.GROUP_KEY);
    if (group != null && group.length() > 0) {
      buf.append(group).append("/");
    }
    buf.append(ps.get(Constant.INTERFACE_KEY));
    String version = ps.get(Constant.VERSION_KEY);
  ...
  public static String toArgumentString(Object[] args) {
    ...
    for (Object arg : args) {
      if (buf.length() > 0) {
        buf.append(Constant.COMMA_SEPARATOR);
      }
      if (arg == null || ReflectUtils.isPrimitives(arg.getClass())) {
        buf.append(arg);
      } else {
        buf.append(FastJsonUtil.toJson(arg));
      }
    }
    return buf.toString();
  }
