package com.xiaodou.common.http.socket;
...
public class XdSecureProtocolSocketFactory implements SecureProtocolSocketFactory {

  private SSLContext sslContext = null;

  /**
   * Constructor for XdSecureProtocolSocketFactory.
   */
  public XdSecureProtocolSocketFactory() {}
  ...
  private static SSLContext createEasySSLContext() {
    try {
      ...
      context.init(null, new TrustManager[] {new XdX509TrustManager()}, null);
      return context;
    } catch (Exception e) {
