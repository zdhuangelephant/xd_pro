package com.xiaodou.jmsgauto.vo;
...
public class JmsgAlarm extends AlarmEntityImpl {
  ...
  private String eventModule = "xiaodou-jmsg-auto";
  private String eventName = "jmsg-auto-fail";
  private String messageInfo = "错误消息自动处理系统异常. %s";
  private String mailInfo = "错误消息自动处理系统异常. %s";
